...
def load(newPart):
    ...
    hexID = "FZKICADOOMLOUTOOMPKICADOOMLOUTOOMPPARTSRESE126XO7511R12O751"
    ...
    newPart['footprintKicadDetails'].append({'name': 'RESE-1206-X-O751-01-R12O751', 'description': 'hexID: R12O751;PARTL C-JLCC;C17985;MANUF C-XXXX;1206W4F7500T5E; Resistor SMD 1206 (3216 Metric), square (rectangular) end terminal, IPC_7351 nominal, (Body size source: IPC-SM-782 page 72, https://www.pcb-3d.com/wordpress/wp-content/uploads/ipc-sm-782a_amendment_1_and_2.pdf), generated with kicad-footprint-generator', 'tags': 'resistor', 'attributeType': 'smd', 'threeDModel': '${KICAD6_3DMODEL_DIR}/Resistor_SMD.3dshapes/R_1206_3216Metric.wrl', 'pins': {'type': 'smd', 'shape': 'roundrect'}})

...
def load(newPart):
    ...
    hexID = "FZKICADOOMLOUTOOMPKICADOOMLOUTOOMPJLCCBASICCAPC63XUF2V16C6U216C2363"
    ...
    newPart['name'].append('oomlout_OOMP_JLCC_Basic : CAPC-0603-X-UF2-V16-C6U216-C23630')

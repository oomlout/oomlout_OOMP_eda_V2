...
def load(newPart,it):
    ...
    hexID = "FZKICADOOMLOUTOOMPKICADOOMLOUTOOMPJLCCBASICCAPC42XNF1V16C4N116C1525"
    ...
    newPart['name'].append('oomlout_OOMP_JLCC_Basic : CAPC-0402-X-NF100-V16-C4N10016-C1525')

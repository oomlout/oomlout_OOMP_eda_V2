...
def load(newPart,it):
    ...
    hexID = "FZKICADOOMLOUTOOMPKICADOOMLOUTOOMPJLCCBASICRESE85XO341R8O34C17616"
    ...
    newPart['footprintKicadDetails'].append({'name': 'RESE-0805-X-O304-01-R8O304-C17616', 'description': 'hexID: R8O304;PARTL C-JLCC;C17616;MANUF C-XXXX;0805W8F3003T5E; Resistor SMD 0805 (2012 Metric), square (rectangular) end terminal, IPC_7351 nominal, (Body size source: IPC-SM-782 page 72, https://www.pcb-3d.com/wordpress/wp-content/uploads/ipc-sm-782a_amendment_1_and_2.pdf), generated with kicad-footprint-generator', 'tags': 'resistor', 'attributeType': 'smd', 'threeDModel': '${KICAD6_3DMODEL_DIR}/Resistor_SMD.3dshapes/R_0805_2012Metric.wrl', 'pins': {'type': 'smd', 'shape': 'roundrect'}})

...
def load(newPart):
    ...
    hexID = "FZKICADOOMLOUTOOMPKICADOOMLOUTOOMPJLCCBASICCAPC63XUF1V1C6U11C1972"
    ...
    newPart['name'].append('oomlout_OOMP_JLCC_Basic : CAPC-0603-X-UF10-V10-C6U1010-C19702')

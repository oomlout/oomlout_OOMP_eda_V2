...
def load(newPart,it):
    ...
    hexID = "FZKICADOOMLOUTOOMPKICADOOMLOUTOOMPJLCCBASICCAPC85XUF47DV25C8U47DC1779"
    ...
    newPart['name'].append('oomlout_OOMP_JLCC_Basic : CAPC-0805-X-UF47D-V25-C8U47D-C1779')

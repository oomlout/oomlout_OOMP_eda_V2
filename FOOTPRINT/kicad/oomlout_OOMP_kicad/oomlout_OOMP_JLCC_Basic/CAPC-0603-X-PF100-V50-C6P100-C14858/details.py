...
def load(newPart):
    ...
    hexID = "FZKICADOOMLOUTOOMPKICADOOMLOUTOOMPJLCCBASICCAPC63XPF1V5C6P1C14858"
    ...
    newPart['name'].append('oomlout_OOMP_JLCC_Basic : CAPC-0603-X-PF100-V50-C6P100-C14858')

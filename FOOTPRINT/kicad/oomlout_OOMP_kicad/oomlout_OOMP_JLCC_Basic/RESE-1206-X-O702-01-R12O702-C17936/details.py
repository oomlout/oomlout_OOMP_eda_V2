...
def load(newPart):
    ...
    hexID = "FZKICADOOMLOUTOOMPKICADOOMLOUTOOMPJLCCBASICRESE126XO721R12O72C17936"
    ...
    newPart['name'].append('oomlout_OOMP_JLCC_Basic : RESE-1206-X-O702-01-R12O702-C17936')

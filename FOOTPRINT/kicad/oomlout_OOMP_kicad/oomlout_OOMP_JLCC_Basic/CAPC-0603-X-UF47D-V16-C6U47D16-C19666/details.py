...
def load(newPart,it):
    ...
    hexID = "FZKICADOOMLOUTOOMPKICADOOMLOUTOOMPJLCCBASICCAPC63XUF47DV16C6U47D16C19666"
    ...
    newPart['name'].append('oomlout_OOMP_JLCC_Basic : CAPC-0603-X-UF47D-V16-C6U47D16-C19666')

...
def load(newPart):
    ...
    hexID = "FZKICADOOMLOUTOOMPKICADOOMLOUTOOMPJLCCBASICRESE85XO3311R8O331C1763"
    ...
    newPart['footprintKicadDetails'].append({'name': 'RESE-0805-X-O331-01-R8O331-C17630', 'description': 'hexID: R8O331;PARTL C-JLCC;C17630;MANUF C-XXXX;0805W8F3300T5E; Resistor SMD 0805 (2012 Metric), square (rectangular) end terminal, IPC_7351 nominal, (Body size source: IPC-SM-782 page 72, https://www.pcb-3d.com/wordpress/wp-content/uploads/ipc-sm-782a_amendment_1_and_2.pdf), generated with kicad-footprint-generator', 'tags': 'resistor', 'attributeType': 'smd', 'threeDModel': '${KICAD6_3DMODEL_DIR}/Resistor_SMD.3dshapes/R_0805_2012Metric.wrl', 'pins': {'type': 'smd', 'shape': 'roundrect'}})

...
def load(newPart):
    ...
    hexID = "FZKICADOOMLOUTOOMPKICADOOMLOUTOOMPJLCCBASICCAPC126XUF7V1C12U71C96123"
    ...
    newPart['name'].append('oomlout_OOMP_JLCC_Basic : CAPC-1206-X-UF7-V10-C12U710-C96123')

...
def load(newPart):
    ...
    hexID = "FZKICADOOMLOUTOOMPKICADOOMLOUTOOMPJLCCBASICCAPC63XPF47DV5C6P47DC1669"
    ...
    newPart['name'].append('oomlout_OOMP_JLCC_Basic : CAPC-0603-X-PF47D-V50-C6P47D-C1669')

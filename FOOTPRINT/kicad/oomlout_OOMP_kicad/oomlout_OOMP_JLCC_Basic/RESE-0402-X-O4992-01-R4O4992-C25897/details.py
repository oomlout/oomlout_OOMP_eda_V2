...
def load(newPart):
    ...
    hexID = "FZKICADOOMLOUTOOMPKICADOOMLOUTOOMPJLCCBASICRESE42XO49921R4O4992C25897"
    ...
    newPart['footprintKicadDetails'].append({'name': 'RESE-0402-X-O4992-01-R4O4992-C25897', 'description': 'hexID: R4O4992;PARTL C-JLCC;C25897;MANUF C-XXXX;0402WGF4992TCE; Resistor SMD 0402 (1005 Metric), square (rectangular) end terminal, IPC_7351 nominal, (Body size source: IPC-SM-782 page 72, https://www.pcb-3d.com/wordpress/wp-content/uploads/ipc-sm-782a_amendment_1_and_2.pdf), generated with kicad-footprint-generator', 'tags': 'resistor', 'attributeType': 'smd', 'threeDModel': '${KICAD6_3DMODEL_DIR}/Resistor_SMD.3dshapes/R_0402_1005Metric.wrl', 'pins': {'type': 'smd', 'shape': 'roundrect'}})

...
def load(newPart,it):
    ...
    oIndex = "TE_3-84952-0_1x30-1MP_P1.0mm_Horizontal"
    hexID = "FZKCNFFCFPCTE3849521X31MPP1HORIZONTAL"
    ...
    newPart['name'].append('Connector_FFC-FPC : TE_3-84952-0_1x30-1MP_P1.0mm_Horizontal')

...
def load(newPart):
    ...
    oIndex = "Mounting_Wuerth_WA-SMST-3.3mm_H14mm_9774140960"
    hexID = "FZKMONMONWASMST33H1497741496"
    ...
    newPart['name'].append('Mounting_Wuerth : Mounting_Wuerth_WA-SMST-3.3mm_H14mm_9774140960')

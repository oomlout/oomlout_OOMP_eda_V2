...
def load(newPart,it):
    ...
    oIndex = "Mounting_Wuerth_WA-SMST-4.5mm_H4mm_9774040982"
    hexID = "FZKMONMONWASMST45H497744982"
    ...
    newPart['name'].append('Mounting_Wuerth : Mounting_Wuerth_WA-SMST-4.5mm_H4mm_9774040982')

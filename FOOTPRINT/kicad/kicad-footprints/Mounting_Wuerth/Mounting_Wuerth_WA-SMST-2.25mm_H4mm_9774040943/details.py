...
def load(newPart):
    ...
    oIndex = "Mounting_Wuerth_WA-SMST-2.25mm_H4mm_9774040943"
    hexID = "FZKMONMONWASMST225H497744943"
    ...
    newPart['name'].append('Mounting_Wuerth : Mounting_Wuerth_WA-SMST-2.25mm_H4mm_9774040943')

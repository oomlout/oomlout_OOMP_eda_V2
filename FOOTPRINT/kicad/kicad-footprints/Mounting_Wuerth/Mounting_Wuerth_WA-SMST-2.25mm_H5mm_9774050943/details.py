...
def load(newPart):
    ...
    oIndex = "Mounting_Wuerth_WA-SMST-2.25mm_H5mm_9774050943"
    hexID = "FZKMONMONWASMST225H597745943"
    ...
    newPart['name'].append('Mounting_Wuerth : Mounting_Wuerth_WA-SMST-2.25mm_H5mm_9774050943')

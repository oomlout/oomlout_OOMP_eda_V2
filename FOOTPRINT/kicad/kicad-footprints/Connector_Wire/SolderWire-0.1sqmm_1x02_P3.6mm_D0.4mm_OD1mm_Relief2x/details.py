...
def load(newPart):
    ...
    oIndex = "SolderWire-0.1sqmm_1x02_P3.6mm_D0.4mm_OD1mm_Relief2x"
    hexID = "FZKCNWIRESOLDERWIRE1SQ1X2P36D4OD1RELIEF2X"
    ...
    newPart['name'].append('Connector_Wire : SolderWire-0.1sqmm_1x02_P3.6mm_D0.4mm_OD1mm_Relief2x')

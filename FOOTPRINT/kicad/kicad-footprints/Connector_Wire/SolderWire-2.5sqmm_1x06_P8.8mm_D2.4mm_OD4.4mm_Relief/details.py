...
def load(newPart):
    ...
    oIndex = "SolderWire-2.5sqmm_1x06_P8.8mm_D2.4mm_OD4.4mm_Relief"
    hexID = "FZKCNWIRESOLDERWIRE25SQ1X6P88D24OD44RELIEF"
    ...
    newPart['name'].append('Connector_Wire : SolderWire-2.5sqmm_1x06_P8.8mm_D2.4mm_OD4.4mm_Relief')

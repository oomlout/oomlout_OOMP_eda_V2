...
def load(newPart):
    ...
    oIndex = "SolderWire-0.127sqmm_1x06_P3.7mm_D0.48mm_OD1mm_Relief2x"
    hexID = "FZKCNWIRESOLDERWIRE127SQ1X6P37D48OD1RELIEF2X"
    ...
    newPart['name'].append('Connector_Wire : SolderWire-0.127sqmm_1x06_P3.7mm_D0.48mm_OD1mm_Relief2x')

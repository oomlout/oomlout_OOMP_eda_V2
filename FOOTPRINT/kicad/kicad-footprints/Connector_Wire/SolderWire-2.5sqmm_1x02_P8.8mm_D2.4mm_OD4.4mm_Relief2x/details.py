...
def load(newPart,it):
    ...
    oIndex = "SolderWire-2.5sqmm_1x02_P8.8mm_D2.4mm_OD4.4mm_Relief2x"
    hexID = "FZKCNWIRESOLDERWIRE25SQ1X2P88D24OD44RELIEF2X"
    ...
    newPart['name'].append('Connector_Wire : SolderWire-2.5sqmm_1x02_P8.8mm_D2.4mm_OD4.4mm_Relief2x')

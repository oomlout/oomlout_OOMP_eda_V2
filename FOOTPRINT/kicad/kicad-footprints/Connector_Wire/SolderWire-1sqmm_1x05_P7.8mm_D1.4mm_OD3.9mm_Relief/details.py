...
def load(newPart,it):
    ...
    oIndex = "SolderWire-1sqmm_1x05_P7.8mm_D1.4mm_OD3.9mm_Relief"
    hexID = "FZKCNWIRESOLDERWIRE1SQ1X5P78D14OD39RELIEF"
    ...
    newPart['name'].append('Connector_Wire : SolderWire-1sqmm_1x05_P7.8mm_D1.4mm_OD3.9mm_Relief')

...
def load(newPart,it):
    ...
    oIndex = "PhoenixContact_GMSTBVA_2,5_4-G_1x04_P7.50mm_Vertical"
    hexID = "FZKCNPHOENIXGMSTBPHOENIXCONTACTGMSTBVA254G1X4P75VERTICAL"
    ...
    newPart['name'].append('Connector_Phoenix_GMSTB : PhoenixContact_GMSTBVA_2,5_4-G_1x04_P7.50mm_Vertical')

...
def load(newPart):
    ...
    oIndex = "Harwin_Gecko-G125-MVX1605L0X_2x08_P1.25mm_Vertical"
    hexID = "FZKCNHARWINHARWINGECKOG125MVX165LX2X8P125VERTICAL"
    ...
    newPart['name'].append('Connector_Harwin : Harwin_Gecko-G125-MVX1605L0X_2x08_P1.25mm_Vertical')

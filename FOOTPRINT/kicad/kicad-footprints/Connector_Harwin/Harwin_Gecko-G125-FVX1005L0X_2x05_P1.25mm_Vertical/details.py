...
def load(newPart):
    ...
    oIndex = "Harwin_Gecko-G125-FVX1005L0X_2x05_P1.25mm_Vertical"
    hexID = "FZKCNHARWINHARWINGECKOG125FVX15LX2X5P125VERTICAL"
    ...
    newPart['name'].append('Connector_Harwin : Harwin_Gecko-G125-FVX1005L0X_2x05_P1.25mm_Vertical')

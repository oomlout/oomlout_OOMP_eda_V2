...
def load(newPart):
    ...
    oIndex = "Harwin_Gecko-G125-FVX2605L0X_2x13_P1.25mm_Vertical"
    hexID = "FZKCNHARWINHARWINGECKOG125FVX265LX2X13P125VERTICAL"
    ...
    newPart['name'].append('Connector_Harwin : Harwin_Gecko-G125-FVX2605L0X_2x13_P1.25mm_Vertical')

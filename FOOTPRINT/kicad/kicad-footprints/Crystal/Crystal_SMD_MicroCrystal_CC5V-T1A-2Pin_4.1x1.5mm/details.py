...
def load(newPart):
    ...
    oDesc = "Crystal"
    oIndex = "Crystal_SMD_MicroCrystal_CC5V-T1A-2Pin_4.1x1.5mm"
    hexID = "FZKXXSMMXCC5VT1A2PIN41X15"
    ...
    newPart['name'].append('Crystal : Crystal_SMD_MicroCrystal_CC5V-T1A-2Pin_4.1x1.5mm')

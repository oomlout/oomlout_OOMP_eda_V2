...
def load(newPart,it):
    ...
    oDesc = "Crystal"
    oIndex = "Crystal_DS26_D2.0mm_L6.0mm_Horizontal_1EP_style1"
    hexID = "FZKXXDS26D2L6HORIZONTAL1EPSTYLE1"
    ...
    newPart['name'].append('Crystal : Crystal_DS26_D2.0mm_L6.0mm_Horizontal_1EP_style1')

...
def load(newPart):
    ...
    oIndex = "CP_EIA-7361-38_AVX-V_Pad2.18x3.30mm_HandSolder"
    hexID = "FZKCAPACITORTANTALUMSMCPEIA736138AVXVPAD218X33HANDSOLDER"

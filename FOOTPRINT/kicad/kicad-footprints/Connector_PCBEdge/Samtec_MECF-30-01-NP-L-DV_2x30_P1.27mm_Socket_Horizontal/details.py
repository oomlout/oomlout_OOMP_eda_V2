...
def load(newPart,it):
    ...
    oIndex = "Samtec_MECF-30-01-NP-L-DV_2x30_P1.27mm_Socket_Horizontal"
    hexID = "FZKCNPCBEDGESAMTECMECF31NPLDV2X3P127SOHORIZONTAL"

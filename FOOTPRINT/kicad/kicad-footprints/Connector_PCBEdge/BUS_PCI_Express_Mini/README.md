...
* [FZKCNPEBUSPCIEXPRESSM > Connector_PCBEdge : BUS_PCI_Express_Mini](#fzkcnpebuspciexpressm--connector_pcbedge--bus_pci_express_mini)
	* [Images](#images)
	* [Tags](#tags)
  
![][im]
# FZKCNPEBUSPCIEXPRESSM > Connector_PCBEdge : BUS_PCI_Express_Mini

- ID: FOOTPRINT-kicad-kicad-footprints-Connector_PCBEdge-BUS_PCI_Express_Mini
- Hex ID: FZKCNPEBUSPCIEXPRESSM
- Name: Connector_PCBEdge : BUS_PCI_Express_Mini
- Path: oomlout_OOMP_eda_V2/FOOTPRINT/kicad/kicad-footprints/Connector_PCBEdge/BUS_PCI_Express_Mini/
...
- Short Link: [http://oom.lt/FZKCNPEBUSPCIEXPRESSM](http://oom.lt/FZKCNPEBUSPCIEXPRESSM)
...
|Hex ID (short code)|hexID|FZKCNPEBUSPCIEXPRESSM|

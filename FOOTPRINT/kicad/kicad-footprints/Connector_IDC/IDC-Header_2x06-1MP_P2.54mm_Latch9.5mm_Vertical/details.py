...
def load(newPart):
    ...
    oDesc = "Connector_IDC"
    oIndex = "IDC-Header_2x06-1MP_P2.54mm_Latch9.5mm_Vertical"
    hexID = "FZKCNIDCIDCHEADER2X61MPP254LATCH95VERTICAL"
    ...
    newPart['name'].append('Connector_IDC : IDC-Header_2x06-1MP_P2.54mm_Latch9.5mm_Vertical')

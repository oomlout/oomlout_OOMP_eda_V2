...
def load(newPart,it):
    ...
    oIndex = "DSUB-37_Male_Horizontal_P2.77x2.84mm_EdgePinOffset7.70mm_Housed_MountingHolesOffset9.12mm"
    hexID = "FZKCNDSUBDSUB37MALEHORIZONTALP277X284EDGEPINOFFSET77HOUSEDHOLSOFFSET912"
    ...
    newPart['name'].append('Connector_Dsub : DSUB-37_Male_Horizontal_P2.77x2.84mm_EdgePinOffset7.70mm_Housed_MountingHolesOffset9.12mm')

...
def load(newPart,it):
    ...
    oIndex = "DSUB-25_Female_Horizontal_P2.77x2.84mm_EdgePinOffset9.40mm"
    hexID = "FZKCNDSUBDSUB25FEMALEHORIZONTALP277X284EDGEPINOFFSET94"
    ...
    newPart['name'].append('Connector_Dsub : DSUB-25_Female_Horizontal_P2.77x2.84mm_EdgePinOffset9.40mm')

...
def load(newPart):
    ...
    oIndex = "TO-50-4_ShortPad-WithHole_Housing"
    hexID = "FZKPACKAGETOSOTSMTO54SHORTPADWITHHOLEHOUSING"
    ...
    newPart['name'].append('Package_TO_SOT_SMD : TO-50-4_ShortPad-WithHole_Housing')

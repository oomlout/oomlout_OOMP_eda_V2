...
def load(newPart,it):
    ...
    oIndex = "TE_MATE-N-LOK_1-794069-x_2x09_P4.14mm_Vertical"
    hexID = "FZKCNTECONNECTIVITYTEMATENLOK179469X2X9P414VERTICAL"

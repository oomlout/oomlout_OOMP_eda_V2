...
def load(newPart):
    ...
    oDesc = "Module"
    oIndex = "Adafruit_HUZZAH_ESP8266_breakout_WithMountingHoles"
    hexID = "FZKMOADAHUZZAHESP8266BREAKOUTWITOUNTINGH"

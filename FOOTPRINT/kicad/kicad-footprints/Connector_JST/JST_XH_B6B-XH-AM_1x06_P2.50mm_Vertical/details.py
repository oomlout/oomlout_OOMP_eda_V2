...
def load(newPart,it):
    ...
    oDesc = "Connector_JST"
    oIndex = "JST_XH_B6B-XH-AM_1x06_P2.50mm_Vertical"
    hexID = "FZKCNJSTJSTXHB6BXHAM1X6P25VERTICAL"

...
def load(newPart):
    ...
    oDesc = "Connector_JST"
    oIndex = "JST_XH_B7B-XH-AM_1x07_P2.50mm_Vertical"
    hexID = "FZKCNJSTJSTXHB7BXHAM1X7P25VERTICAL"

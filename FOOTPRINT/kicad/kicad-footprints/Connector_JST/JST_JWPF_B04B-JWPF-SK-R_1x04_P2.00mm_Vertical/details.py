...
def load(newPart,it):
    ...
    oDesc = "Connector_JST"
    oIndex = "JST_JWPF_B04B-JWPF-SK-R_1x04_P2.00mm_Vertical"
    hexID = "FZKCNJSTJSTJWPFB4BJWPFSKR1X4P2VERTICAL"

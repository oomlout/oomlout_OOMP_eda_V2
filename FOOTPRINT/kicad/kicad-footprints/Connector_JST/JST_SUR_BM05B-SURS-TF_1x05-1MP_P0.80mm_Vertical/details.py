...
def load(newPart,it):
    ...
    oDesc = "Connector_JST"
    oIndex = "JST_SUR_BM05B-SURS-TF_1x05-1MP_P0.80mm_Vertical"
    hexID = "FZKCNJSTJSTSURBM5BSURSTF1X51MPP8VERTICAL"

...
def load(newPart):
    ...
    oDesc = "Connector_JST"
    oIndex = "JST_ZE_B04B-ZESK-D_1x04_P1.50mm_Vertical"
    hexID = "FZKCNJSTJSTZEB4BZESKD1X4P15VERTICAL"
    ...
    newPart['name'].append('Connector_JST : JST_ZE_B04B-ZESK-D_1x04_P1.50mm_Vertical')

...
def load(newPart,it):
    ...
    oDesc = "Connector_JST"
    oIndex = "JST_XH_S5B-XH-A_1x05_P2.50mm_Horizontal"
    hexID = "FZKCNJSTJSTXHS5BXHA1X5P25HORIZONTAL"
    ...
    newPart['name'].append('Connector_JST : JST_XH_S5B-XH-A_1x05_P2.50mm_Horizontal')

...
def load(newPart,it):
    ...
    oDesc = "Connector_JST"
    oIndex = "JST_XH_B2B-XH-AM_1x02_P2.50mm_Vertical"
    hexID = "FZKCNJSTJSTXHB2BXHAM1X2P25VERTICAL"
    ...
    newPart['name'].append('Connector_JST : JST_XH_B2B-XH-AM_1x02_P2.50mm_Vertical')

...
def load(newPart):
    ...
    oDesc = "Connector_JST"
    oIndex = "JST_XH_B3B-XH-AM_1x03_P2.50mm_Vertical"
    hexID = "FZKCNJSTJSTXHB3BXHAM1X3P25VERTICAL"

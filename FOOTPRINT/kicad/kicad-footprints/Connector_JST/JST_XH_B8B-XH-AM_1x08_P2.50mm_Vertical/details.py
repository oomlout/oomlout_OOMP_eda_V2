...
def load(newPart):
    ...
    oDesc = "Connector_JST"
    oIndex = "JST_XH_B8B-XH-AM_1x08_P2.50mm_Vertical"
    hexID = "FZKCNJSTJSTXHB8BXHAM1X8P25VERTICAL"

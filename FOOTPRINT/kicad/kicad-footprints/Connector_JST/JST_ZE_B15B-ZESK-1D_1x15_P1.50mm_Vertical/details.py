...
def load(newPart):
    ...
    oDesc = "Connector_JST"
    oIndex = "JST_ZE_B15B-ZESK-1D_1x15_P1.50mm_Vertical"
    hexID = "FZKCNJSTJSTZEB15BZESK1D1X15P15VERTICAL"

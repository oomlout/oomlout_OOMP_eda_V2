...
def load(newPart):
    ...
    oDesc = "Connector_JST"
    oIndex = "JST_XH_B5B-XH-AM_1x05_P2.50mm_Vertical"
    hexID = "FZKCNJSTJSTXHB5BXHAM1X5P25VERTICAL"

...
def load(newPart,it):
    ...
    oDesc = "Connector_JST"
    oIndex = "JST_XH_B12B-XH-AM_1x12_P2.50mm_Vertical"
    hexID = "FZKCNJSTJSTXHB12BXHAM1X12P25VERTICAL"

...
def load(newPart):
    ...
    oIndex = "TerminalBlock_4Ucon_1x13_P3.50mm_Vertical"
    hexID = "FZKTB4UCONTB4UCON1X13P35VERTICAL"
    ...
    newPart['name'].append('TerminalBlock_4Ucon : TerminalBlock_4Ucon_1x13_P3.50mm_Vertical')

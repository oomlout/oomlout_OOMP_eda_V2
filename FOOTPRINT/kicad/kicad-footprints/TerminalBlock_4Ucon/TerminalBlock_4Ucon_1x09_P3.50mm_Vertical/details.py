...
def load(newPart,it):
    ...
    oIndex = "TerminalBlock_4Ucon_1x09_P3.50mm_Vertical"
    hexID = "FZKTB4UCONTB4UCON1X9P35VERTICAL"
    ...
    newPart['name'].append('TerminalBlock_4Ucon : TerminalBlock_4Ucon_1x09_P3.50mm_Vertical')

...
- ID: FOOTPRINT-kicad-kicad-footprints-Button_Switch_Keyboard-SW_Cherry_MX_2.00u_Vertical_PCB
- Hex ID: FZKBSWCHERRYMX2UVERTICALPCB
- Name: Button_Switch_Keyboard : SW_Cherry_MX_2.00u_Vertical_PCB
...
[(Aliexpress) ](https://www.aliexpress.com/wholesale?SearchText=1117Button_Switch_Keyboard+:+SW_Cherry_MX_2.00u_Vertical_PCB)&nbsp;&nbsp;&nbsp;[(Avnet) ](https://www.avnet.com/shop/us/search/Button_Switch_Keyboard+:+SW_Cherry_MX_2.00u_Vertical_PCB)&nbsp;&nbsp;&nbsp;[(Digikey) ](https://www.digikey.co.uk/en/products/result?s=Button_Switch_Keyboard+:+SW_Cherry_MX_2.00u_Vertical_PCB)&nbsp;&nbsp;&nbsp;[(LCSC) ](https://www.lcsc.com/search?q=Button_Switch_Keyboard+:+SW_Cherry_MX_2.00u_Vertical_PCB)&nbsp;&nbsp;&nbsp;[(Farnell) ](https://uk.farnell.com/search?st=Button_Switch_Keyboard+:+SW_Cherry_MX_2.00u_Vertical_PCB)&nbsp;&nbsp;&nbsp;[(Mouser) ](https://www.mouser.com/c/?q=Button_Switch_Keyboard+:+SW_Cherry_MX_2.00u_Vertical_PCB)&nbsp;&nbsp;&nbsp;
## MPNs
...
|OOMP Index|oompIndex|SW_Cherry_MX_2.00u_Vertical_PCB|
|Full OOMP ID|oompID|FOOTPRINT-kicad-kicad-footprints-Button_Switch_Keyboard-SW_Cherry_MX_2.00u_Vertical_PCB|
|Hex ID (short code)|hexID|FZKBSWCHERRYMX2UVERTICALPCB|
|name|name|Button_Switch_Keyboard : SW_Cherry_MX_2.00u_Vertical_PCB|
|Footprint Kicad|footprintKicadDetails|<table><tr><td>'name'</td></tr><tr><td> 'SW_Cherry_MX_2.00u_Vertical_PCB'</td><td> 'description'</td></tr><tr><td> 'Cherry MX keyswitch</td><td> 2.00u</td><td> vertical</td><td> PCB mount</td><td> http</td></tr><tr><td>//cherryamericas.com/wp-content/uploads/2014/12/mx_cat.pdf'</td><td> 'tags'</td></tr><tr><td> 'Cherry MX keyswitch 2.00u vertical PCB'</td><td> 'attributeType'</td></tr><tr><td> 'through_hole'</td><td> 'threeDModel'</td></tr><tr><td> '$<table><tr><td>KICAD6_3DMODEL_DIR</td></tr></table>/Button_Switch_Keyboard.3dshapes/SW_Cherry_MX_2.00u_Vertical_PCB.wrl'</td><td> 'pins'</td></tr><tr><td> <table><tr><td>'type'</td></tr><tr><td> 'np_thru_hole'</td><td> 'shape'</td></tr><tr><td> 'circle'</td></tr></table></td></tr></table>|
||||

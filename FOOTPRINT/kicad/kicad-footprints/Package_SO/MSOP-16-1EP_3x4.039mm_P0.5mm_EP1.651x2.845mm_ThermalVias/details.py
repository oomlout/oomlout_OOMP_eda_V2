...
def load(newPart,it):
    ...
    oDesc = "Package_SO"
    oIndex = "MSOP-16-1EP_3x4.039mm_P0.5mm_EP1.651x2.845mm_ThermalVias"
    hexID = "FZKSOMS161EP3X439P5EP1651X2845THERMALVIAS"
    ...
    newPart['name'].append('Package_SO : MSOP-16-1EP_3x4.039mm_P0.5mm_EP1.651x2.845mm_ThermalVias')

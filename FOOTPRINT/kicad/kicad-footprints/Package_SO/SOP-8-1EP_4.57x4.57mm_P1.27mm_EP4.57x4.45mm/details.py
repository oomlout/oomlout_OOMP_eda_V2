...
def load(newPart):
    ...
    oDesc = "Package_SO"
    oIndex = "SOP-8-1EP_4.57x4.57mm_P1.27mm_EP4.57x4.45mm"
    hexID = "FZKSOS81EP457X457P127EP457X445"
    ...
    newPart['name'].append('Package_SO : SOP-8-1EP_4.57x4.57mm_P1.27mm_EP4.57x4.45mm')

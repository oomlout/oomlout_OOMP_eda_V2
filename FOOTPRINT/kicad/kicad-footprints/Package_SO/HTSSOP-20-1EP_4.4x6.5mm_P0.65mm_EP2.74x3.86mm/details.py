...
def load(newPart,it):
    ...
    oDesc = "Package_SO"
    oIndex = "HTSSOP-20-1EP_4.4x6.5mm_P0.65mm_EP2.74x3.86mm"
    hexID = "FZKSOHTSS21EP44X65P65EP274X386"

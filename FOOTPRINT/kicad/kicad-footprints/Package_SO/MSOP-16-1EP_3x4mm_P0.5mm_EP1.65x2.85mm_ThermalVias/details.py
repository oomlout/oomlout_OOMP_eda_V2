...
def load(newPart):
    ...
    oDesc = "Package_SO"
    oIndex = "MSOP-16-1EP_3x4mm_P0.5mm_EP1.65x2.85mm_ThermalVias"
    hexID = "FZKSOMS161EP3X4P5EP165X285THERMALVIAS"
    ...
    newPart['name'].append('Package_SO : MSOP-16-1EP_3x4mm_P0.5mm_EP1.65x2.85mm_ThermalVias')

...
def load(newPart):
    ...
    oIndex = "PhoenixContact_MC_1,5_7-G-5.08_1x07_P5.08mm_Horizontal"
    hexID = "FZKCNPHOENIXMCHIGHVOLTAGEPHOENIXCONTACTMC157G581X7P58HORIZONTAL"
    ...
    newPart['name'].append('Connector_Phoenix_MC_HighVoltage : PhoenixContact_MC_1,5_7-G-5.08_1x07_P5.08mm_Horizontal')

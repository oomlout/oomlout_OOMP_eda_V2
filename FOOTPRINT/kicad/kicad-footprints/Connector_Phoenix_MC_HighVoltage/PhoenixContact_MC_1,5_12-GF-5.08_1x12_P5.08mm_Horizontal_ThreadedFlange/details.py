...
def load(newPart,it):
    ...
    oIndex = "PhoenixContact_MC_1,5_12-GF-5.08_1x12_P5.08mm_Horizontal_ThreadedFlange"
    hexID = "FZKCNPHOENIXMCHIGHVOLTAGEPHOENIXCONTACTMC1512GF581X12P58HORIZONTALTHREADEDFLANGE"
    ...
    newPart['name'].append('Connector_Phoenix_MC_HighVoltage : PhoenixContact_MC_1,5_12-GF-5.08_1x12_P5.08mm_Horizontal_ThreadedFlange')

...
def load(newPart,it):
    ...
    oIndex = "Converter_ACDC_Vigortronix_VTX-214-015-1xx_THT"
    hexID = "FZKCONCONVIGORTRONIXVTX214151XXTHT"
    ...
    newPart['name'].append('Converter_ACDC : Converter_ACDC_Vigortronix_VTX-214-015-1xx_THT')

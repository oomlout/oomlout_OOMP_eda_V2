...
- ID: FOOTPRINT-kicad-kicad-footprints-Converter_ACDC-Converter_ACDC_Vigortronix_VTX-214-010-xxx_THT
- Hex ID: FZKCONCONVIGORTRONIXVTX2141XXXTHT
- Name: Converter_ACDC : Converter_ACDC_Vigortronix_VTX-214-010-xxx_THT
- Description: Converter_ACDC : Converter_ACDC_Vigortronix_VTX-214-010-xxx_THT
- Long Link: [http://oom.lt/FOOTPRINT-kicad-kicad-footprints-Converter_ACDC-Converter_ACDC_Vigortronix_VTX-214-010-xxx_THT](http://oom.lt/FOOTPRINT-kicad-kicad-footprints-Converter_ACDC-Converter_ACDC_Vigortronix_VTX-214-010-xxx_THT)
- Short Link: [http://oom.lt/FZKCONCONVIGORTRONIXVTX2141XXXTHT](http://oom.lt/FZKCONCONVIGORTRONIXVTX2141XXXTHT)

## Distributor Searches
  
Links to search for this item (using OOMP name) at various distributors  
[(Aliexpress) ](https://www.aliexpress.com/wholesale?SearchText=1117Converter_ACDC+:+Converter_ACDC_Vigortronix_VTX-214-010-xxx_THT)&nbsp;&nbsp;&nbsp;[(Avnet) ](https://www.avnet.com/shop/us/search/Converter_ACDC+:+Converter_ACDC_Vigortronix_VTX-214-010-xxx_THT)&nbsp;&nbsp;&nbsp;[(Digikey) ](https://www.digikey.co.uk/en/products/result?s=Converter_ACDC+:+Converter_ACDC_Vigortronix_VTX-214-010-xxx_THT)&nbsp;&nbsp;&nbsp;[(LCSC) ](https://www.lcsc.com/search?q=Converter_ACDC+:+Converter_ACDC_Vigortronix_VTX-214-010-xxx_THT)&nbsp;&nbsp;&nbsp;[(Farnell) ](https://uk.farnell.com/search?st=Converter_ACDC+:+Converter_ACDC_Vigortronix_VTX-214-010-xxx_THT)&nbsp;&nbsp;&nbsp;[(Mouser) ](https://www.mouser.com/c/?q=Converter_ACDC+:+Converter_ACDC_Vigortronix_VTX-214-010-xxx_THT)&nbsp;&nbsp;&nbsp;
## MPNs
...
|OOMP Index|oompIndex|Converter_ACDC_Vigortronix_VTX-214-010-xxx_THT|
|Full OOMP ID|oompID|FOOTPRINT-kicad-kicad-footprints-Converter_ACDC-Converter_ACDC_Vigortronix_VTX-214-010-xxx_THT|
|Hex ID (short code)|hexID|FZKCONCONVIGORTRONIXVTX2141XXXTHT|
|name|name|Converter_ACDC : Converter_ACDC_Vigortronix_VTX-214-010-xxx_THT|
|Footprint Kicad|footprintKicadDetails|<table><tr><td>'name'</td></tr><tr><td> 'Converter_ACDC_Vigortronix_VTX-214-010-xxx_THT'</td><td> 'description'</td></tr><tr><td> 'Vigortronix VTX-214-010-xxx serie of ACDC converter</td><td> http</td></tr><tr><td>//www.vigortronix.com/10WattACDCPCBPowerModule.aspx'</td><td> 'tags'</td></tr><tr><td> 'Vigortronix VTX-214-010-xxx serie of ACDC converter'</td><td> 'attributeType'</td></tr><tr><td> 'through_hole'</td><td> 'threeDModel'</td></tr><tr><td> '$<table><tr><td>KICAD6_3DMODEL_DIR</td></tr></table>/Converter_ACDC.3dshapes/Converter_ACDC_Vigortronix_VTX-214-010-xxx_THT.wrl'</td><td> 'pins'</td></tr><tr><td> <table><tr><td>'type'</td></tr><tr><td> 'thru_hole'</td><td> 'shape'</td></tr><tr><td> 'rect'</td></tr></table></td></tr></table>|
||||

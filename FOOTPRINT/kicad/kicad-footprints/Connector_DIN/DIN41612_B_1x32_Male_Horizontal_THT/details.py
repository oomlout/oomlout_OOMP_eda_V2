...
def load(newPart,it):
    ...
    oDesc = "Connector_DIN"
    oIndex = "DIN41612_B_1x32_Male_Horizontal_THT"
    hexID = "FZKCNDINDIN41612B1X32MALEHORIZONTALTHT"

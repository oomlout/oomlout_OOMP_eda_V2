...
def load(newPart,it):
    ...
    oIndex = "TerminalBlock_MetzConnect_Type701_RT11L03HGLU_1x03_P6.35mm_Horizontal"
    hexID = "FZKTBMETZCONNECTTBMETZCONNECTTYPE71RT11L3HGLU1X3P635HORIZONTAL"

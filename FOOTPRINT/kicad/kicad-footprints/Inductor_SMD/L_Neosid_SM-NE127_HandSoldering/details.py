...
def load(newPart,it):
    ...
    oDesc = "Inductor_SMD"
    oIndex = "L_Neosid_SM-NE127_HandSoldering"
    hexID = "FZKINDUCTORSMLNEOSIDSMNE127HANDSOLDERING"

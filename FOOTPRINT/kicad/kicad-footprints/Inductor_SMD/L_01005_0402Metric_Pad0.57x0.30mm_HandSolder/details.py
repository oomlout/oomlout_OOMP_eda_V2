...
def load(newPart):
    ...
    oDesc = "Inductor_SMD"
    oIndex = "L_01005_0402Metric_Pad0.57x0.30mm_HandSolder"
    hexID = "FZKINDUCTORSML1542METRICPAD57X3HANDSOLDER"

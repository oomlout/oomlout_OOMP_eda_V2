...
def load(newPart):
    ...
    oIndex = "Molex_Micro-Fit_3.0_43045-1418_2x07-1MP_P3.00mm_Vertical"
    hexID = "FZKCNMXMXMFIT3434514182X71MPP3VERTICAL"
    ...
    newPart['name'].append('Connector_Molex : Molex_Micro-Fit_3.0_43045-1418_2x07-1MP_P3.00mm_Vertical')

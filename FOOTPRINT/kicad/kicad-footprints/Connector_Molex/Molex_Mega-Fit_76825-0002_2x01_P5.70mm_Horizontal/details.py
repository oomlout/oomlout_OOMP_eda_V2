...
def load(newPart,it):
    ...
    oIndex = "Molex_Mega-Fit_76825-0002_2x01_P5.70mm_Horizontal"
    hexID = "FZKCNMXMXMEGAFIT7682522X1P57HORIZONTAL"
    ...
    newPart['name'].append('Connector_Molex : Molex_Mega-Fit_76825-0002_2x01_P5.70mm_Horizontal')

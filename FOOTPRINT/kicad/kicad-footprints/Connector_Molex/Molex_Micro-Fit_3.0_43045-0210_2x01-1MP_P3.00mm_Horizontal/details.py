...
def load(newPart,it):
    ...
    oIndex = "Molex_Micro-Fit_3.0_43045-0210_2x01-1MP_P3.00mm_Horizontal"
    ...
    newPart['name'].append('Connector_Molex : Molex_Micro-Fit_3.0_43045-0210_2x01-1MP_P3.00mm_Horizontal')

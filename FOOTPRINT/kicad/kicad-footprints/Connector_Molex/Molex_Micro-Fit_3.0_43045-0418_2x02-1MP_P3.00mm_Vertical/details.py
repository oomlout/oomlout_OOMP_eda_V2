...
def load(newPart,it):
    ...
    oIndex = "Molex_Micro-Fit_3.0_43045-0418_2x02-1MP_P3.00mm_Vertical"
    hexID = "FZKCNMXMXMFIT343454182X21MPP3VERTICAL"
    ...
    newPart['name'].append('Connector_Molex : Molex_Micro-Fit_3.0_43045-0418_2x02-1MP_P3.00mm_Vertical')

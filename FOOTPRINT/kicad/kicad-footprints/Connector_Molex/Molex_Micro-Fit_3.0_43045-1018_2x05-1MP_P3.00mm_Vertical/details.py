...
def load(newPart,it):
    ...
    oIndex = "Molex_Micro-Fit_3.0_43045-1018_2x05-1MP_P3.00mm_Vertical"
    hexID = "FZKCNMXMXMFIT343451182X51MPP3VERTICAL"
    ...
    newPart['name'].append('Connector_Molex : Molex_Micro-Fit_3.0_43045-1018_2x05-1MP_P3.00mm_Vertical')

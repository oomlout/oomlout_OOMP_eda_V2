...
def load(newPart):
    ...
    oIndex = "Molex_Micro-Fit_3.0_43045-0218_2x01-1MP_P3.00mm_Vertical"
    hexID = "FZKCNMXMXMFIT343452182X11MPP3VERTICAL"
    ...
    newPart['name'].append('Connector_Molex : Molex_Micro-Fit_3.0_43045-0218_2x01-1MP_P3.00mm_Vertical')

...
def load(newPart,it):
    ...
    oIndex = "Molex_Micro-Fit_3.0_43045-0818_2x04-1MP_P3.00mm_Vertical"
    hexID = "FZKCNMXMXMFIT343458182X41MPP3VERTICAL"
    ...
    newPart['name'].append('Connector_Molex : Molex_Micro-Fit_3.0_43045-0818_2x04-1MP_P3.00mm_Vertical')

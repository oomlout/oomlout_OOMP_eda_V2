...
def load(newPart,it):
    ...
    oIndex = "Molex_Micro-Fit_3.0_43045-0600_2x03_P3.00mm_Horizontal"
    hexID = "FZKCNMXMXMFIT3434562X3P3HORIZONTAL"
    ...
    newPart['name'].append('Connector_Molex : Molex_Micro-Fit_3.0_43045-0600_2x03_P3.00mm_Horizontal')

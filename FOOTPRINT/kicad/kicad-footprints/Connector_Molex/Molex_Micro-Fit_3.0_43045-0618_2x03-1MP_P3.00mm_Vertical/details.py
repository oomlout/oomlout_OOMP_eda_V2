...
def load(newPart,it):
    ...
    oIndex = "Molex_Micro-Fit_3.0_43045-0618_2x03-1MP_P3.00mm_Vertical"
    hexID = "FZKCNMXMXMFIT343456182X31MPP3VERTICAL"
    ...
    newPart['name'].append('Connector_Molex : Molex_Micro-Fit_3.0_43045-0618_2x03-1MP_P3.00mm_Vertical')

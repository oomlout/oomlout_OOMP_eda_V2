...
def load(newPart):
    ...
    oIndex = "Molex_Micro-Fit_3.0_43045-1218_2x06-1MP_P3.00mm_Vertical"
    hexID = "FZKCNMXMXMFIT3434512182X61MPP3VERTICAL"
    ...
    newPart['name'].append('Connector_Molex : Molex_Micro-Fit_3.0_43045-1218_2x06-1MP_P3.00mm_Vertical')

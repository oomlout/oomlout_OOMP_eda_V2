...
def load(newPart):
    ...
    oIndex = "Molex_Micro-Fit_3.0_43045-1818_2x09-1MP_P3.00mm_Vertical"
    hexID = "FZKCNMXMXMFIT3434518182X91MPP3VERTICAL"
    ...
    newPart['name'].append('Connector_Molex : Molex_Micro-Fit_3.0_43045-1818_2x09-1MP_P3.00mm_Vertical')

...
def load(newPart):
    ...
    oIndex = "Molex_Micro-Fit_3.0_43045-2215_2x11_P3.00mm_Vertical"
    hexID = "FZKCNMXMXMFIT3434522152X11P3VERTICAL"
    ...
    newPart['name'].append('Connector_Molex : Molex_Micro-Fit_3.0_43045-2215_2x11_P3.00mm_Vertical')

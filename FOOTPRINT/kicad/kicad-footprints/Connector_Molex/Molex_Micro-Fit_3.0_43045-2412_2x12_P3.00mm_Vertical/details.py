...
def load(newPart,it):
    ...
    oIndex = "Molex_Micro-Fit_3.0_43045-2412_2x12_P3.00mm_Vertical"
    hexID = "FZKCNMXMXMFIT3434524122X12P3VERTICAL"
    ...
    newPart['name'].append('Connector_Molex : Molex_Micro-Fit_3.0_43045-2412_2x12_P3.00mm_Vertical')

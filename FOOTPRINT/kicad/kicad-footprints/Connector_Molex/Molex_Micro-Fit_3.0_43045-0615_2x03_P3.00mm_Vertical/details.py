...
def load(newPart,it):
    ...
    oIndex = "Molex_Micro-Fit_3.0_43045-0615_2x03_P3.00mm_Vertical"
    hexID = "FZKCNMXMXMFIT343456152X3P3VERTICAL"
    ...
    newPart['name'].append('Connector_Molex : Molex_Micro-Fit_3.0_43045-0615_2x03_P3.00mm_Vertical')

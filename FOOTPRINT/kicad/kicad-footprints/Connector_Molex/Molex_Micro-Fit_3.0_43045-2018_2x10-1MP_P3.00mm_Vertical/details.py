...
def load(newPart):
    ...
    oIndex = "Molex_Micro-Fit_3.0_43045-2018_2x10-1MP_P3.00mm_Vertical"
    ...
    newPart['name'].append('Connector_Molex : Molex_Micro-Fit_3.0_43045-2018_2x10-1MP_P3.00mm_Vertical')

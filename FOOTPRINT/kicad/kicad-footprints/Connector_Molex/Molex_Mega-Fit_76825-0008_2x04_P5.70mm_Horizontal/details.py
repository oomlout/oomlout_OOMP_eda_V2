...
def load(newPart,it):
    ...
    oIndex = "Molex_Mega-Fit_76825-0008_2x04_P5.70mm_Horizontal"
    hexID = "FZKCNMXMXMEGAFIT7682582X4P57HORIZONTAL"
    ...
    newPart['name'].append('Connector_Molex : Molex_Mega-Fit_76825-0008_2x04_P5.70mm_Horizontal')

...
def load(newPart,it):
    ...
    oIndex = "Molex_Sabre_46007-1102_1x02_P7.49mm_Horizontal"
    hexID = "FZKCNMXMXSABRE4671121X2P749HORIZONTAL"
    ...
    newPart['name'].append('Connector_Molex : Molex_Sabre_46007-1102_1x02_P7.49mm_Horizontal')

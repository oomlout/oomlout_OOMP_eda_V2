...
def load(newPart):
    ...
    oIndex = "Molex_Micro-Fit_3.0_43045-1618_2x08-1MP_P3.00mm_Vertical"
    hexID = "FZKCNMXMXMFIT3434516182X81MPP3VERTICAL"
    ...
    newPart['name'].append('Connector_Molex : Molex_Micro-Fit_3.0_43045-1618_2x08-1MP_P3.00mm_Vertical')

...
def load(newPart,it):
    ...
    oIndex = "Molex_Sabre_43160-0103_1x03_P7.49mm_Vertical"
    hexID = "FZKCNMXMXSABRE4316131X3P749VERTICAL"
    ...
    newPart['name'].append('Connector_Molex : Molex_Sabre_43160-0103_1x03_P7.49mm_Vertical')

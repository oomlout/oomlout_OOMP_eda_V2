...
def load(newPart,it):
    ...
    oIndex = "Molex_Micro-Fit_3.0_43045-1812_2x09_P3.00mm_Vertical"
    hexID = "FZKCNMXMXMFIT3434518122X9P3VERTICAL"
    ...
    newPart['name'].append('Connector_Molex : Molex_Micro-Fit_3.0_43045-1812_2x09_P3.00mm_Vertical')

...
def load(newPart):
    ...
    oIndex = "WDFN-8-1EP_4x3mm_P0.65mm_EP2.4x1.8mm_ThermalVias"
    hexID = "FZKDFNWDFN81EP4X3P65EP24X18THERMALVIAS"
    ...
    newPart['name'].append('Package_DFN_QFN : WDFN-8-1EP_4x3mm_P0.65mm_EP2.4x1.8mm_ThermalVias')

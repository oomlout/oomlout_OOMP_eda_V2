...
def load(newPart,it):
    ...
    oIndex = "HVQFN-40-1EP_6x6mm_P0.5mm_EP4.1x4.1mm"
    hexID = "FZKDFNHVQFN41EP6X6P5EP41X41"
    ...
    newPart['name'].append('Package_DFN_QFN : HVQFN-40-1EP_6x6mm_P0.5mm_EP4.1x4.1mm')

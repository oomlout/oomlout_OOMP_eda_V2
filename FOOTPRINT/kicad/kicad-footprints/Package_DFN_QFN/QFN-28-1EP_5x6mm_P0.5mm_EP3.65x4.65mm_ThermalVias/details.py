...
def load(newPart):
    ...
    oIndex = "QFN-28-1EP_5x6mm_P0.5mm_EP3.65x4.65mm_ThermalVias"
    hexID = "FZKDFNQFN281EP5X6P5EP365X465THERMALVIAS"
    ...
    newPart['name'].append('Package_DFN_QFN : QFN-28-1EP_5x6mm_P0.5mm_EP3.65x4.65mm_ThermalVias')

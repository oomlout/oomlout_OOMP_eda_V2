...
def load(newPart,it):
    ...
    oIndex = "TQFN-20-1EP_5x5mm_P0.65mm_EP3.25x3.25mm_ThermalVias"
    hexID = "FZKDFNTQFN21EP5X5P65EP325X325THERMALVIAS"
    ...
    newPart['name'].append('Package_DFN_QFN : TQFN-20-1EP_5x5mm_P0.65mm_EP3.25x3.25mm_ThermalVias')

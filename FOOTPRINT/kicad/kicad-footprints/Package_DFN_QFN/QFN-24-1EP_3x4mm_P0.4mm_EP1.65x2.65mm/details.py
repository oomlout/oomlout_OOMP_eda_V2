...
def load(newPart):
    ...
    oIndex = "QFN-24-1EP_3x4mm_P0.4mm_EP1.65x2.65mm"
    hexID = "FZKDFNQFN241EP3X4P4EP165X265"
    ...
    newPart['name'].append('Package_DFN_QFN : QFN-24-1EP_3x4mm_P0.4mm_EP1.65x2.65mm')

...
def load(newPart):
    ...
    oIndex = "QFN-52-1EP_7x8mm_P0.5mm_EP5.41x6.45mm"
    hexID = "FZKDFNQFN521EP7X8P5EP541X645"
    ...
    newPart['name'].append('Package_DFN_QFN : QFN-52-1EP_7x8mm_P0.5mm_EP5.41x6.45mm')

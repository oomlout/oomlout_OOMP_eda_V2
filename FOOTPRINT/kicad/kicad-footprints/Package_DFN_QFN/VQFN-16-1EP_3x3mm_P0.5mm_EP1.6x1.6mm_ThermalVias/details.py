...
def load(newPart,it):
    ...
    oIndex = "VQFN-16-1EP_3x3mm_P0.5mm_EP1.6x1.6mm_ThermalVias"
    hexID = "FZKDFNVQFN161EP3X3P5EP16X16THERMALVIAS"
    ...
    newPart['name'].append('Package_DFN_QFN : VQFN-16-1EP_3x3mm_P0.5mm_EP1.6x1.6mm_ThermalVias')

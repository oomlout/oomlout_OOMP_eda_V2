...
def load(newPart,it):
    ...
    oIndex = "QFN-16-1EP_4x4mm_P0.65mm_EP2.7x2.7mm_PullBack"
    hexID = "FZKDFNQFN161EP4X4P65EP27X27PULLBACK"
    ...
    newPart['name'].append('Package_DFN_QFN : QFN-16-1EP_4x4mm_P0.65mm_EP2.7x2.7mm_PullBack')

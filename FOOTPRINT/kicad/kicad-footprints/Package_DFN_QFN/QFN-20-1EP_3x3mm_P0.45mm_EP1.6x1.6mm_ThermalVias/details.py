...
def load(newPart,it):
    ...
    oIndex = "QFN-20-1EP_3x3mm_P0.45mm_EP1.6x1.6mm_ThermalVias"
    hexID = "FZKDFNQFN21EP3X3P45EP16X16THERMALVIAS"
    ...
    newPart['name'].append('Package_DFN_QFN : QFN-20-1EP_3x3mm_P0.45mm_EP1.6x1.6mm_ThermalVias')

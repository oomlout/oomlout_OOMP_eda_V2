...
def load(newPart):
    ...
    oIndex = "PinSocket_1x38_P1.27mm_Vertical_SMD_Pin1Left"
    hexID = "FZKCNPINSO127PINSO1X38P127VERTICALSMPIN1LEFT"
    ...
    newPart['name'].append('Connector_PinSocket_1.27mm : PinSocket_1x38_P1.27mm_Vertical_SMD_Pin1Left')

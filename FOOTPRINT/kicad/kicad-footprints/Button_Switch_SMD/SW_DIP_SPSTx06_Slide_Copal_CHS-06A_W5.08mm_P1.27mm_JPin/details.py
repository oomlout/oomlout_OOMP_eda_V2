...
def load(newPart,it):
    ...
    oIndex = "SW_DIP_SPSTx06_Slide_Copal_CHS-06A_W5.08mm_P1.27mm_JPin"
    hexID = "FZKBSWITCHSMSWDIPSPSTX6SLIDECOPALCHS6AW58P127JPIN"
    ...
    newPart['name'].append('Button_Switch_SMD : SW_DIP_SPSTx06_Slide_Copal_CHS-06A_W5.08mm_P1.27mm_JPin')

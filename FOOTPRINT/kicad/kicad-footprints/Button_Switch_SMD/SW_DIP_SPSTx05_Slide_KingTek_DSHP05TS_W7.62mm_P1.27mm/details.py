...
def load(newPart):
    ...
    oIndex = "SW_DIP_SPSTx05_Slide_KingTek_DSHP05TS_W7.62mm_P1.27mm"
    hexID = "FZKBSWITCHSMSWDIPSPSTX5SLIDEKINGTEKDSHP5TSW762P127"

...
def load(newPart):
    ...
    oIndex = "Potentiometer_Piher_PT-6-H_Horizontal"
    hexID = "FZKPPOTENTIOMETERPIHERPT6HHORIZONTAL"
    ...
    newPart['name'].append('Potentiometer_THT : Potentiometer_Piher_PT-6-H_Horizontal')

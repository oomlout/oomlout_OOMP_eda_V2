...
def load(newPart):
    ...
    oIndex = "PhoenixContact_MSTBVA_2,5_15-G_1x15_P5.00mm_Vertical"
    hexID = "FZKCNPHOENIXMSTBPHOENIXCONTACTMSTBVA2515G1X15P5VERTICAL"
    ...
    newPart['name'].append('Connector_Phoenix_MSTB : PhoenixContact_MSTBVA_2,5_15-G_1x15_P5.00mm_Vertical')

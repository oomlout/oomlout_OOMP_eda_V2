...
def load(newPart):
    ...
    oIndex = "PhoenixContact_MSTBV_2,5_13-GF-5,08_1x13_P5.08mm_Vertical_ThreadedFlange_MountHole"
    hexID = "FZKCNPHOENIXMSTBPHOENIXCONTACTMSTBV2513GF581X13P58VERTICALTHREADEDFLANGEMOUNTHOLE"
    ...
    newPart['name'].append('Connector_Phoenix_MSTB : PhoenixContact_MSTBV_2,5_13-GF-5,08_1x13_P5.08mm_Vertical_ThreadedFlange_MountHole')

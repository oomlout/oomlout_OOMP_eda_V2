...
def load(newPart):
    ...
    oDesc = "Resistor_THT"
    oIndex = "R_Axial_DIN0414_L11.9mm_D4.5mm_P5.08mm_Vertical"
    hexID = "FZKRRAXIALDIN414L119D45P58VERTICAL"
    ...
    newPart['name'].append('Resistor_THT : R_Axial_DIN0414_L11.9mm_D4.5mm_P5.08mm_Vertical')

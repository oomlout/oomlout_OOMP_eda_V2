...
def load(newPart):
    ...
    oDesc = "Resistor_THT"
    oIndex = "R_Axial_DIN0204_L3.6mm_D1.6mm_P5.08mm_Horizontal"
    hexID = "FZKRRAXIALDIN24L36D16P58HORIZONTAL"
    ...
    newPart['name'].append('Resistor_THT : R_Axial_DIN0204_L3.6mm_D1.6mm_P5.08mm_Horizontal')

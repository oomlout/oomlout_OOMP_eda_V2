...
def load(newPart):
    ...
    oDesc = "Resistor_THT"
    oIndex = "R_Axial_DIN0414_L11.9mm_D4.5mm_P15.24mm_Horizontal"
    hexID = "FZKRRAXIALDIN414L119D45P1524HORIZONTAL"
    ...
    newPart['name'].append('Resistor_THT : R_Axial_DIN0414_L11.9mm_D4.5mm_P15.24mm_Horizontal')

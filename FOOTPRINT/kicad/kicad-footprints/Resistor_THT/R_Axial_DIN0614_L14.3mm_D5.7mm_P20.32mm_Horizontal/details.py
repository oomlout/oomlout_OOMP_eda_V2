...
def load(newPart):
    ...
    oDesc = "Resistor_THT"
    oIndex = "R_Axial_DIN0614_L14.3mm_D5.7mm_P20.32mm_Horizontal"
    hexID = "FZKRRAXIALDIN614L143D57P232HORIZONTAL"

...
def load(newPart):
    ...
    oDesc = "Oscillator"
    oIndex = "Oscillator_SMD_Fordahl_DFAS15-4Pin_5.0x3.2mm_HandSoldering"
    hexID = "FZKOCSOCSSMFORDAHLDFAS154PIN5X32HANDSOLDERING"

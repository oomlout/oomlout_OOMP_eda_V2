...
def load(newPart,it):
    ...
    oDesc = "Oscillator"
    oIndex = "Oscillator_SMD_SeikoEpson_SG8002LB-4Pin_5.0x3.2mm_HandSoldering"
    hexID = "FZKOCSOCSSMSEIKOEPSONSG82LB4PIN5X32HANDSOLDERING"

...
def load(newPart):
    ...
    oIndex = "Samtec_HLE-147-02-xxx-DV-BE_2x47_P2.54mm_Horizontal"
    hexID = "FZKCNSAMTECHLESMSAMTECHLE1472XXXDVBE2X47P254HORIZONTAL"
    ...
    newPart['name'].append('Connector_Samtec_HLE_SMD : Samtec_HLE-147-02-xxx-DV-BE_2x47_P2.54mm_Horizontal')

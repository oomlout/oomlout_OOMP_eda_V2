...
def load(newPart):
    ...
    oDesc = "Connector_JAE"
    oIndex = "JAE_LY20-34P-DT1_2x17_P2.00mm_Vertical"
    hexID = "FZKCNJAEJAELY234PDT12X17P2VERTICAL"

...
def load(newPart):
    ...
    oDesc = "Package_LGA"
    oIndex = "Linear_LGA-133_15.0x15.0mm_Layout12x12_P1.27mm"
    hexID = "FZKLGALINEARLGA13315X15LAYOUT12X12P127"

...
![][im]
# FZKBSWPUSHLCDE3SAXXXXSINS > Button_Switch_THT : SW_PUSH_LCD_E3_SAxxxx_SocketPins
...
[(Aliexpress) ](https://www.aliexpress.com/wholesale?SearchText=1117Button_Switch_THT+:+SW_PUSH_LCD_E3_SAxxxx_SocketPins)&nbsp;&nbsp;&nbsp;[(Avnet) ](https://www.avnet.com/shop/us/search/Button_Switch_THT+:+SW_PUSH_LCD_E3_SAxxxx_SocketPins)&nbsp;&nbsp;&nbsp;[(Digikey) ](https://www.digikey.co.uk/en/products/result?s=Button_Switch_THT+:+SW_PUSH_LCD_E3_SAxxxx_SocketPins)&nbsp;&nbsp;&nbsp;[(LCSC) ](https://www.lcsc.com/search?q=Button_Switch_THT+:+SW_PUSH_LCD_E3_SAxxxx_SocketPins)&nbsp;&nbsp;&nbsp;[(Farnell) ](https://uk.farnell.com/search?st=Button_Switch_THT+:+SW_PUSH_LCD_E3_SAxxxx_SocketPins)&nbsp;&nbsp;&nbsp;[(Mouser) ](https://www.mouser.com/c/?q=Button_Switch_THT+:+SW_PUSH_LCD_E3_SAxxxx_SocketPins)&nbsp;&nbsp;&nbsp;
## MPNs
...
| :---: | :---: | :---: | :---: |
|kicadPcb3d<br>[![](https://raw.githubusercontent.com/oomlout/oomlout_OOMP_eda_V2/main/FOOTPRINT/kicad/kicad-footprints/Button_Switch_THT/SW_PUSH_LCD_E3_SAxxxx_SocketPins/kicadPcb3d_140.png)](https://github.com/oomlout/oomlout_OOMP_eda_V2/tree/main/FOOTPRINT/kicad/kicad-footprints/Button_Switch_THT/SW_PUSH_LCD_E3_SAxxxx_SocketPins/kicadPcb3d.png)||||
...
|OOMP Index|oompIndex|SW_PUSH_LCD_E3_SAxxxx_SocketPins|
|Full OOMP ID|oompID|FOOTPRINT-kicad-kicad-footprints-Button_Switch_THT-SW_PUSH_LCD_E3_SAxxxx_SocketPins|
|Hex ID (short code)|hexID|FZKBSWPUSHLCDE3SAXXXXSINS|
|name|name|Button_Switch_THT : SW_PUSH_LCD_E3_SAxxxx_SocketPins|
|Footprint Kicad|footprintKicadDetails|<table><tr><td>'name'</td></tr><tr><td> 'SW_PUSH_LCD_E3_SAxxxx_SocketPins'</td><td> 'description'</td></tr><tr><td> 'Switch with LCD screen E3 SAxxxx'</td><td> 'tags'</td></tr><tr><td> 'switch normally-open pushbutton push-button LCD'</td><td> 'attributeType'</td></tr><tr><td> 'through_hole'</td><td> 'threeDModel'</td></tr><tr><td> '$<table><tr><td>KICAD6_3DMODEL_DIR</td></tr></table>/Button_Switch_THT.3dshapes/SW_PUSH_LCD_E3_SAxxxx_SocketPins.wrl'</td><td> 'pins'</td></tr><tr><td> <table><tr><td>'type'</td></tr><tr><td> 'np_thru_hole'</td><td> 'shape'</td></tr><tr><td> 'circle'</td></tr></table></td></tr></table>|
||||

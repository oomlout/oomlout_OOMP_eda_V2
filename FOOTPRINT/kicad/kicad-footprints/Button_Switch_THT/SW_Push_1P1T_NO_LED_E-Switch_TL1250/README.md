...
* [FZKBSWPUSH1P1TNOLESWTL125 > Button_Switch_THT : SW_Push_1P1T_NO_LED_E-Switch_TL1250](#fzkbswpush1p1tnoleswtl125--button_switch_tht--sw_push_1p1t_no_led_e-switch_tl1250)
	* [Images](#images)
	* [Tags](#tags)
  
![][im]
# FZKBSWPUSH1P1TNOLESWTL125 > Button_Switch_THT : SW_Push_1P1T_NO_LED_E-Switch_TL1250

- ID: FOOTPRINT-kicad-kicad-footprints-Button_Switch_THT-SW_Push_1P1T_NO_LED_E-Switch_TL1250
- Hex ID: FZKBSWPUSH1P1TNOLESWTL125
- Name: Button_Switch_THT : SW_Push_1P1T_NO_LED_E-Switch_TL1250
- Path: oomlout_OOMP_eda_V2/FOOTPRINT/kicad/kicad-footprints/Button_Switch_THT/SW_Push_1P1T_NO_LED_E-Switch_TL1250/
- Description: Button_Switch_THT : SW_Push_1P1T_NO_LED_E-Switch_TL1250
- Long Link: [http://oom.lt/FOOTPRINT-kicad-kicad-footprints-Button_Switch_THT-SW_Push_1P1T_NO_LED_E-Switch_TL1250](http://oom.lt/FOOTPRINT-kicad-kicad-footprints-Button_Switch_THT-SW_Push_1P1T_NO_LED_E-Switch_TL1250)
- Short Link: [http://oom.lt/FZKBSWPUSH1P1TNOLESWTL125](http://oom.lt/FZKBSWPUSH1P1TNOLESWTL125)
...
|Hex ID (short code)|hexID|FZKBSWPUSH1P1TNOLESWTL125|
|name|name|Button_Switch_THT : SW_Push_1P1T_NO_LED_E-Switch_TL1250|
|Footprint Kicad|footprintKicadDetails|<table><tr><td>'name'</td></tr><tr><td> 'SW_Push_1P1T_NO_LED_E-Switch_TL1250'</td><td> 'description'</td></tr><tr><td> 'illuminated right angle tact switch https</td></tr><tr><td>//www.e-switch.com/system/asset/product_line/data_sheet/148/TL1250.pdf'</td><td> 'tags'</td></tr><tr><td> 'led push switch right angle'</td><td> 'attributeType'</td></tr><tr><td> 'through_hole'</td><td> 'threeDModel'</td></tr><tr><td> '$<table><tr><td>KICAD6_3DMODEL_DIR</td></tr></table>/Button_Switch_THT.3dshapes/SW_Push_1P1T_NO_LED_E-Switch_TL1250.wrl'</td><td> 'pins'</td></tr><tr><td> <table><tr><td>'type'</td></tr><tr><td> 'thru_hole'</td><td> 'shape'</td></tr><tr><td> 'circle'</td></tr></table></td></tr></table>|
||||

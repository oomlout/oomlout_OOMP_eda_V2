...
def load(newPart):
    ...
    oIndex = "Jack_XLR_Neutrik_NC3FBH2-E_Horizontal"
    hexID = "FZKCNAUDIOJXLRNEUTRIKNC3FBH2EHORIZONTAL"
    ...
    newPart['name'].append('Connector_Audio : Jack_XLR_Neutrik_NC3FBH2-E_Horizontal')

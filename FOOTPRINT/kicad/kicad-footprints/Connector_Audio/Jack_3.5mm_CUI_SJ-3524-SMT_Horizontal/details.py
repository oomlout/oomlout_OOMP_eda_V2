...
def load(newPart):
    ...
    oIndex = "Jack_3.5mm_CUI_SJ-3524-SMT_Horizontal"
    hexID = "FZKCNAUDIOJ35CUISJ3524SHORIZONTAL"
    ...
    newPart['name'].append('Connector_Audio : Jack_3.5mm_CUI_SJ-3524-SMT_Horizontal')

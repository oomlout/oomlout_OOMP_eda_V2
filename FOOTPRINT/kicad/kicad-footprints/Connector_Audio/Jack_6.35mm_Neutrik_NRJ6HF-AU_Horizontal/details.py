...
def load(newPart,it):
    ...
    oIndex = "Jack_6.35mm_Neutrik_NRJ6HF-AU_Horizontal"
    hexID = "FZKCNAUDIOJ635NEUTRIKNRJ6HFAUHORIZONTAL"
    ...
    newPart['name'].append('Connector_Audio : Jack_6.35mm_Neutrik_NRJ6HF-AU_Horizontal')

...
def load(newPart):
    ...
    oDesc = "Package_CSP"
    oIndex = "LFCSP-16-1EP_3x3mm_P0.5mm_EP1.6x1.6mm_ThermalVias"
    hexID = "FZKCSPLFCSP161EP3X3P5EP16X16THERMALVIAS"
    ...
    newPart['name'].append('Package_CSP : LFCSP-16-1EP_3x3mm_P0.5mm_EP1.6x1.6mm_ThermalVias')

...
* [FZKLLCREEXQHS > LED_SMD : LED_Cree-XQ_HandSoldering](#fzkllcreexqhs--led_smd--led_cree-xq_handsoldering)
	* [Images](#images)
	* [Tags](#tags)
  
![][im]
# FZKLLCREEXQHS > LED_SMD : LED_Cree-XQ_HandSoldering

- ID: FOOTPRINT-kicad-kicad-footprints-LED_SMD-LED_Cree-XQ_HandSoldering
- Hex ID: FZKLLCREEXQHS
- Name: LED_SMD : LED_Cree-XQ_HandSoldering
- Path: oomlout_OOMP_eda_V2/FOOTPRINT/kicad/kicad-footprints/LED_SMD/LED_Cree-XQ_HandSoldering/
...
- Short Link: [http://oom.lt/FZKLLCREEXQHS](http://oom.lt/FZKLLCREEXQHS)
...
|Hex ID (short code)|hexID|FZKLLCREEXQHS|

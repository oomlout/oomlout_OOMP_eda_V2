...
def load(newPart):
    ...
    oIndex = "PinHeader_2x05_P2.54mm_Vertical_SMD"
    hexID = "FZKCNPINHEADER254PINHEADER2X5P254VERTICALSM"
    ...
    newPart['name'].append('Connector_PinHeader_2.54mm : PinHeader_2x05_P2.54mm_Vertical_SMD')

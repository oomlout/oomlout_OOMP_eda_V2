...
def load(newPart,it):
    ...
    oDesc = "Capacitor_THT"
    oIndex = "C_Axial_L12.0mm_D7.5mm_P15.00mm_Horizontal"
    hexID = "FZKCCAXIALL12D75P15HORIZONTAL"
    ...
    newPart['name'].append('Capacitor_THT : C_Axial_L12.0mm_D7.5mm_P15.00mm_Horizontal')

...
def load(newPart,it):
    ...
    oIndex = "TerminalBlock_WAGO_236-107_1x07_P5.00mm_45Degree"
    hexID = "FZKTBWAGOTBWAGO236171X7P545DEGREE"
    ...
    newPart['name'].append('TerminalBlock_WAGO : TerminalBlock_WAGO_236-107_1x07_P5.00mm_45Degree')

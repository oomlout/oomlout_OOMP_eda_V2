...
def load(newPart):
    ...
    oIndex = "TerminalBlock_WAGO_236-136_1x36_P5.00mm_45Degree"
    hexID = "FZKTBWAGOTBWAGO2361361X36P545DEGREE"
    ...
    newPart['name'].append('TerminalBlock_WAGO : TerminalBlock_WAGO_236-136_1x36_P5.00mm_45Degree')

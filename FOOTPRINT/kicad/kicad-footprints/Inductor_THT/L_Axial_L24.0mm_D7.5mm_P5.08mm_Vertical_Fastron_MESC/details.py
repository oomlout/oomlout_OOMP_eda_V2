...
def load(newPart,it):
    ...
    oDesc = "Inductor_THT"
    oIndex = "L_Axial_L24.0mm_D7.5mm_P5.08mm_Vertical_Fastron_MESC"
    hexID = "FZKINLAXIALL24D75P58VERTICALFASTRONMESC"

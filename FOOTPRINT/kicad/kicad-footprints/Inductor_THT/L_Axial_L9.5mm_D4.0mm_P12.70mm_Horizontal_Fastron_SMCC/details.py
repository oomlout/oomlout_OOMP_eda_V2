...
def load(newPart,it):
    ...
    oDesc = "Inductor_THT"
    oIndex = "L_Axial_L9.5mm_D4.0mm_P12.70mm_Horizontal_Fastron_SMCC"
    hexID = "FZKINLAXIALL95D4P127HORIZONTALFASTRONSMCC"
    ...
    newPart['name'].append('Inductor_THT : L_Axial_L9.5mm_D4.0mm_P12.70mm_Horizontal_Fastron_SMCC')

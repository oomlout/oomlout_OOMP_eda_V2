...
def load(newPart,it):
    ...
    oDesc = "Inductor_THT"
    oIndex = "L_Toroid_Horizontal_D32.5mm_P30.00mm_Bourns_2300"
    hexID = "FZKINLTOROIDHORIZONTALD325P3BOURNS23"

...
def load(newPart):
    ...
    oDesc = "Inductor_THT"
    oIndex = "L_Axial_L16.0mm_D7.5mm_P20.32mm_Horizontal_Fastron_XHBCC"
    hexID = "FZKINLAXIALL16D75P232HORIZONTALFASTRONXHBCC"
    ...
    newPart['name'].append('Inductor_THT : L_Axial_L16.0mm_D7.5mm_P20.32mm_Horizontal_Fastron_XHBCC')

...
def load(newPart,it):
    ...
    oDesc = "Inductor_THT"
    oIndex = "L_Axial_L16.0mm_D9.5mm_P20.32mm_Horizontal_Vishay_IM-10-37"
    hexID = "FZKINLAXIALL16D95P232HORIZONTALVISHAYIM137"
    ...
    newPart['name'].append('Inductor_THT : L_Axial_L16.0mm_D9.5mm_P20.32mm_Horizontal_Vishay_IM-10-37')

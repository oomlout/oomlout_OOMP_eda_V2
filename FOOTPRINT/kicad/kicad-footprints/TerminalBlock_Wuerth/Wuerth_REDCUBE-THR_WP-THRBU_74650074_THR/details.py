...
def load(newPart):
    ...
    oIndex = "Wuerth_REDCUBE-THR_WP-THRBU_74650074_THR"
    hexID = "FZKTBWUERTHWUERTHREDCUBETHRWPTHRBU746574THR"
    ...
    newPart['name'].append('TerminalBlock_Wuerth : Wuerth_REDCUBE-THR_WP-THRBU_74650074_THR')

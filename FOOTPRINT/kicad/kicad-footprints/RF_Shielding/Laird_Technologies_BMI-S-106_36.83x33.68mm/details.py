...
def load(newPart,it):
    ...
    oDesc = "RF_Shielding"
    oIndex = "Laird_Technologies_BMI-S-106_36.83x33.68mm"
    hexID = "FZKRFSLAIRDTECHNOLOGIESBMIS163683X3368"
    ...
    newPart['name'].append('RF_Shielding : Laird_Technologies_BMI-S-106_36.83x33.68mm')

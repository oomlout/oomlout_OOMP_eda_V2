...
def load(newPart):
    ...
    oDesc = "RF_Shielding"
    oIndex = "Laird_Technologies_BMI-S-201-F_13.66x12.70mm"
    hexID = "FZKRFSLAIRDTECHNOLOGIESBMIS21F1366X127"
    ...
    newPart['name'].append('RF_Shielding : Laird_Technologies_BMI-S-201-F_13.66x12.70mm')

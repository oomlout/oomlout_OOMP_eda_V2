...
def load(newPart,it):
    ...
    oDesc = "RF_Shielding"
    oIndex = "Laird_Technologies_BMI-S-209-F_29.36x18.50mm"
    hexID = "FZKRFSLAIRDTECHNOLOGIESBMIS29F2936X185"
    ...
    newPart['name'].append('RF_Shielding : Laird_Technologies_BMI-S-209-F_29.36x18.50mm')

...
def load(newPart):
    ...
    oIndex = "Hirose_DF3EA-05P-2H_1x05-1MP_P2.00mm_Horizontal"
    hexID = "FZKCNHIROSEHIROSEDF3EA5P2H1X51MPP2HORIZONTAL"
    ...
    newPart['name'].append('Connector_Hirose : Hirose_DF3EA-05P-2H_1x05-1MP_P2.00mm_Horizontal')

...
def load(newPart):
    ...
    oDesc = "Resistor_SMD"
    oIndex = "R_2010_5025Metric_Pad1.40x2.65mm_HandSolder"
    hexID = "FZKRESISTORSMR21525METRICPAD14X265HANDSOLDER"

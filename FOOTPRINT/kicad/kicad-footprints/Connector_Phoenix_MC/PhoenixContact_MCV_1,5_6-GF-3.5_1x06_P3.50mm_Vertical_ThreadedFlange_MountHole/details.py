...
def load(newPart,it):
    ...
    oIndex = "PhoenixContact_MCV_1,5_6-GF-3.5_1x06_P3.50mm_Vertical_ThreadedFlange_MountHole"
    hexID = "FZKCNPHOENIXMCPHOENIXCONTACTMCV156GF351X6P35VERTICALTHREADEDFLANGEMOUNTHOLE"
    ...
    newPart['name'].append('Connector_Phoenix_MC : PhoenixContact_MCV_1,5_6-GF-3.5_1x06_P3.50mm_Vertical_ThreadedFlange_MountHole')

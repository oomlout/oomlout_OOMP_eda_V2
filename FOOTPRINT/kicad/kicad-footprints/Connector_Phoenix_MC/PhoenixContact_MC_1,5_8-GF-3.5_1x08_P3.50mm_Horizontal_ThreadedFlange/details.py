...
def load(newPart):
    ...
    oIndex = "PhoenixContact_MC_1,5_8-GF-3.5_1x08_P3.50mm_Horizontal_ThreadedFlange"
    hexID = "FZKCNPHOENIXMCPHOENIXCONTACTMC158GF351X8P35HORIZONTALTHREADEDFLANGE"
    ...
    newPart['name'].append('Connector_Phoenix_MC : PhoenixContact_MC_1,5_8-GF-3.5_1x08_P3.50mm_Horizontal_ThreadedFlange')

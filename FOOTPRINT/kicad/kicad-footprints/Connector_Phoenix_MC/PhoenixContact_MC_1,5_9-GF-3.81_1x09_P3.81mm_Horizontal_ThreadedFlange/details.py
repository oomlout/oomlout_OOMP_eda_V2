...
def load(newPart):
    ...
    oIndex = "PhoenixContact_MC_1,5_9-GF-3.81_1x09_P3.81mm_Horizontal_ThreadedFlange"
    hexID = "FZKCNPHOENIXMCPHOENIXCONTACTMC159GF3811X9P381HORIZONTALTHREADEDFLANGE"
    ...
    newPart['name'].append('Connector_Phoenix_MC : PhoenixContact_MC_1,5_9-GF-3.81_1x09_P3.81mm_Horizontal_ThreadedFlange')

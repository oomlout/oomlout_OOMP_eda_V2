...
def load(newPart,it):
    ...
    oIndex = "PhoenixContact_MC_1,5_10-GF-3.81_1x10_P3.81mm_Horizontal_ThreadedFlange_MountHole"
    hexID = "FZKCNPHOENIXMCPHOENIXCONTACTMC151GF3811X1P381HORIZONTALTHREADEDFLANGEMOUNTHOLE"
    ...
    newPart['name'].append('Connector_Phoenix_MC : PhoenixContact_MC_1,5_10-GF-3.81_1x10_P3.81mm_Horizontal_ThreadedFlange_MountHole')

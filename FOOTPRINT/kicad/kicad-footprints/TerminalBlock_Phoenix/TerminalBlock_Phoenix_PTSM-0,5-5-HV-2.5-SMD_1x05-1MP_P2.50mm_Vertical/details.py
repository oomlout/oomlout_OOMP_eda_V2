...
def load(newPart,it):
    ...
    oIndex = "TerminalBlock_Phoenix_PTSM-0,5-5-HV-2.5-SMD_1x05-1MP_P2.50mm_Vertical"
    hexID = "FZKTBPHOENIXTBPHOENIXPTSM55HV25SM1X51MPP25VERTICAL"

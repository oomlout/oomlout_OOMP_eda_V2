...
* [FZESPECIALDIGIC > special : DIGI-C](#fzespecialdigic--special--digi-c)
	* [Tags](#tags)
  
NO IMAGE  
# FZESPECIALDIGIC > special : DIGI-C
...
|OOMP Index|oompIndex|DIGI-C|
|Full OOMP ID|oompID|FOOTPRINT-eagle-eagle-default-special-DIGI-C|
|Hex ID (short code)|hexID|FZESPECIALDIGIC|
|name|name|special : DIGI-C|
||||

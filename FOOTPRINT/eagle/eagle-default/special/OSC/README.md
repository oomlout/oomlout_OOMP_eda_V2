...
* [FZESPECIALOSC > special : OSC](#fzespecialosc--special--osc)
	* [Tags](#tags)
  
NO IMAGE  
# FZESPECIALOSC > special : OSC
...
|OOMP Index|oompIndex|OSC|
|Full OOMP ID|oompID|FOOTPRINT-eagle-eagle-default-special-OSC|
|Hex ID (short code)|hexID|FZESPECIALOSC|
|name|name|special : OSC|
||||

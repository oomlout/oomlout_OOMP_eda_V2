...
* [FZESPECIALDIGIBL > special : DIGI-BL](#fzespecialdigibl--special--digi-bl)
	* [Tags](#tags)
  
NO IMAGE  
# FZESPECIALDIGIBL > special : DIGI-BL
...
|OOMP Index|oompIndex|DIGI-BL|
|Full OOMP ID|oompID|FOOTPRINT-eagle-eagle-default-special-DIGI-BL|
|Hex ID (short code)|hexID|FZESPECIALDIGIBL|
|name|name|special : DIGI-BL|
||||

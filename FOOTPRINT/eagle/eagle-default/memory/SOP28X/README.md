...
* [FZEMEMORYS28X > memory : SOP28X](#fzememorys28x--memory--sop28x)
	* [Tags](#tags)
  
NO IMAGE  
# FZEMEMORYS28X > memory : SOP28X
...
|OOMP Index|oompIndex|SOP28X|
|Full OOMP ID|oompID|FOOTPRINT-eagle-eagle-default-memory-SOP28X|
|Hex ID (short code)|hexID|FZEMEMORYS28X|
|name|name|memory : SOP28X|
||||

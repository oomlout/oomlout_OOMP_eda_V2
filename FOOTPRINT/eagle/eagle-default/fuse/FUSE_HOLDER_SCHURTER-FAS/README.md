...
NO IMAGE  
# FZEFUFUHSCHURTERFAS > fuse : FUSE_HOLDER_SCHURTER-FAS

- ID: FOOTPRINT-eagle-eagle-default-fuse-FUSE_HOLDER_SCHURTER-FAS
- Hex ID: FZEFUFUHSCHURTERFAS
- Name: fuse : FUSE_HOLDER_SCHURTER-FAS
- Path: oomlout_OOMP_eda_V2/FOOTPRINT/eagle/eagle-default/fuse/FUSE_HOLDER_SCHURTER-FAS/
...
|OOMP Index|oompIndex|FUSE_HOLDER_SCHURTER-FAS|
|Full OOMP ID|oompID|FOOTPRINT-eagle-eagle-default-fuse-FUSE_HOLDER_SCHURTER-FAS|
|Hex ID (short code)|hexID|FZEFUFUHSCHURTERFAS|
|name|name|fuse : FUSE_HOLDER_SCHURTER-FAS|
||||

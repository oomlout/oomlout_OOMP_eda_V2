...
* [FZETRANSISTORPOWERTO3B > transistor-power : TO3_B](#fzetransistorpowerto3b--transistor-power--to3_b)
	* [Tags](#tags)
  
NO IMAGE  
# FZETRANSISTORPOWERTO3B > transistor-power : TO3_B
...
|OOMP Index|oompIndex|TO3_B|
|Full OOMP ID|oompID|FOOTPRINT-eagle-eagle-default-transistor-power-TO3_B|
|Hex ID (short code)|hexID|FZETRANSISTORPOWERTO3B|
|name|name|transistor-power : TO3_B|
||||

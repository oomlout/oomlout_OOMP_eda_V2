...
* [FZETRANSISTORPOWERDIRECTFET > transistor-power : DIRECTFET](#fzetransistorpowerdirectfet--transistor-power--directfet)
	* [Tags](#tags)
  
NO IMAGE  
# FZETRANSISTORPOWERDIRECTFET > transistor-power : DIRECTFET
...
|OOMP Index|oompIndex|DIRECTFET|
|Full OOMP ID|oompID|FOOTPRINT-eagle-eagle-default-transistor-power-DIRECTFET|
|Hex ID (short code)|hexID|FZETRANSISTORPOWERDIRECTFET|
|name|name|transistor-power : DIRECTFET|
||||

...
![][im]
# FZECONFCIDDRIIMODUL > con-fci : DDR_II_MODUL
...
|OOMP Index|oompIndex|DDR_II_MODUL|
|Full OOMP ID|oompID|FOOTPRINT-eagle-eagle-default-con-fci-DDR_II_MODUL|
|Hex ID (short code)|hexID|FZECONFCIDDRIIMODUL|
|name|name|con-fci : DDR_II_MODUL|
||||

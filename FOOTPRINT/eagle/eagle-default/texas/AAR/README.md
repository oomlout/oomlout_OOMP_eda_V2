...
NO IMAGE  
# FZETEXASAAR > texas : AAR

- ID: FOOTPRINT-eagle-eagle-default-texas-AAR
- Hex ID: FZETEXASAAR
- Name: texas : AAR
- Path: oomlout_OOMP_eda_V2/FOOTPRINT/eagle/eagle-default/texas/AAR/
...
|Full OOMP ID|oompID|FOOTPRINT-eagle-eagle-default-texas-AAR|
|Hex ID (short code)|hexID|FZETEXASAAR|
|name|name|texas : AAR|
||||

...
* [FZERECTIFIERDFS > rectifier : DFS](#fzerectifierdfs--rectifier--dfs)
	* [Tags](#tags)
  
NO IMAGE  
# FZERECTIFIERDFS > rectifier : DFS
...
|OOMP Index|oompIndex|DFS|
|Full OOMP ID|oompID|FOOTPRINT-eagle-eagle-default-rectifier-DFS|
|Hex ID (short code)|hexID|FZERECTIFIERDFS|
|name|name|rectifier : DFS|
||||

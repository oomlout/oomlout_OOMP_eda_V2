...
* [FZERCLSMCA > rcl : SMC_A](#fzerclsmca--rcl--smc_a)
	* [Tags](#tags)
  
NO IMAGE  
# FZERCLSMCA > rcl : SMC_A
...
|OOMP Index|oompIndex|SMC_A|
|Full OOMP ID|oompID|FOOTPRINT-eagle-eagle-default-rcl-SMC_A|
|Hex ID (short code)|hexID|FZERCLSMCA|
|name|name|rcl : SMC_A|
||||

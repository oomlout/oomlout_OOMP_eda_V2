...
* [FZERELAYPESO > relay : PE-SOCKET](#fzerelaypeso--relay--pe-socket)
	* [Tags](#tags)
  
NO IMAGE  
# FZERELAYPESO > relay : PE-SOCKET
...
|OOMP Index|oompIndex|PE-SOCKET|
|Full OOMP ID|oompID|FOOTPRINT-eagle-eagle-default-relay-PE-SOCKET|
|Hex ID (short code)|hexID|FZERELAYPESO|
|name|name|relay : PE-SOCKET|
||||

...
* [FZERELAYJVKT > relay : JV-KT](#fzerelayjvkt--relay--jv-kt)
	* [Tags](#tags)
  
NO IMAGE  
# FZERELAYJVKT > relay : JV-KT
...
|OOMP Index|oompIndex|JV-KT|
|Full OOMP ID|oompID|FOOTPRINT-eagle-eagle-default-relay-JV-KT|
|Hex ID (short code)|hexID|FZERELAYJVKT|
|name|name|relay : JV-KT|
||||

...
* [FZERELAYTXD2 > relay : TXD2](#fzerelaytxd2--relay--txd2)
	* [Tags](#tags)
  
NO IMAGE  
# FZERELAYTXD2 > relay : TXD2
...
|OOMP Index|oompIndex|TXD2|
|Full OOMP ID|oompID|FOOTPRINT-eagle-eagle-default-relay-TXD2|
|Hex ID (short code)|hexID|FZERELAYTXD2|
|name|name|relay : TXD2|
||||

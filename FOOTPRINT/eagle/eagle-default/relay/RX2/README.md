...
* [FZERELAYRX2 > relay : RX2](#fzerelayrx2--relay--rx2)
	* [Tags](#tags)
  
NO IMAGE  
# FZERELAYRX2 > relay : RX2
...
|OOMP Index|oompIndex|RX2|
|Full OOMP ID|oompID|FOOTPRINT-eagle-eagle-default-relay-RX2|
|Hex ID (short code)|hexID|FZERELAYRX2|
|name|name|relay : RX2|
||||

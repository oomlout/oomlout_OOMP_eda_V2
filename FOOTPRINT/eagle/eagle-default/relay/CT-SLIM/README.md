...
* [FZERELAYCTSLIM > relay : CT-SLIM](#fzerelayctslim--relay--ct-slim)
	* [Tags](#tags)
  
NO IMAGE  
# FZERELAYCTSLIM > relay : CT-SLIM
...
|OOMP Index|oompIndex|CT-SLIM|
|Full OOMP ID|oompID|FOOTPRINT-eagle-eagle-default-relay-CT-SLIM|
|Hex ID (short code)|hexID|FZERELAYCTSLIM|
|name|name|relay : CT-SLIM|
||||

...
* [FZERELAYREED > relay : REED](#fzerelayreed--relay--reed)
	* [Tags](#tags)
  
NO IMAGE  
# FZERELAYREED > relay : REED
...
|OOMP Index|oompIndex|REED|
|Full OOMP ID|oompID|FOOTPRINT-eagle-eagle-default-relay-REED|
|Hex ID (short code)|hexID|FZERELAYREED|
|name|name|relay : REED|
||||

...
* [FZERELAYPASTDSO > relay : PA-STD-SOCKET](#fzerelaypastdso--relay--pa-std-socket)
	* [Tags](#tags)
  
NO IMAGE  
# FZERELAYPASTDSO > relay : PA-STD-SOCKET
...
|OOMP Index|oompIndex|PA-STD-SOCKET|
|Full OOMP ID|oompID|FOOTPRINT-eagle-eagle-default-relay-PA-STD-SOCKET|
|Hex ID (short code)|hexID|FZERELAYPASTDSO|
|name|name|relay : PA-STD-SOCKET|
||||

...
* [FZERELAYNAISL > relay : NAIS-LOGO](#fzerelaynaisl--relay--nais-logo)
	* [Tags](#tags)
  
NO IMAGE  
# FZERELAYNAISL > relay : NAIS-LOGO
...
|OOMP Index|oompIndex|NAIS-LOGO|
|Full OOMP ID|oompID|FOOTPRINT-eagle-eagle-default-relay-NAIS-LOGO|
|Hex ID (short code)|hexID|FZERELAYNAISL|
|name|name|relay : NAIS-LOGO|
||||

...
* [FZERELAYK4PS > relay : K4-PS](#fzerelayk4ps--relay--k4-ps)
	* [Tags](#tags)
  
NO IMAGE  
# FZERELAYK4PS > relay : K4-PS
...
|OOMP Index|oompIndex|K4-PS|
|Full OOMP ID|oompID|FOOTPRINT-eagle-eagle-default-relay-K4-PS|
|Hex ID (short code)|hexID|FZERELAYK4PS|
|name|name|relay : K4-PS|
||||

...
* [FZERELAYK4EBP > relay : K4EBP](#fzerelayk4ebp--relay--k4ebp)
	* [Tags](#tags)
  
NO IMAGE  
# FZERELAYK4EBP > relay : K4EBP
...
|OOMP Index|oompIndex|K4EBP|
|Full OOMP ID|oompID|FOOTPRINT-eagle-eagle-default-relay-K4EBP|
|Hex ID (short code)|hexID|FZERELAYK4EBP|
|name|name|relay : K4EBP|
||||

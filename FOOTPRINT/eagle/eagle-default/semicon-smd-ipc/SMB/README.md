...
* [FZESEMICONSMIPCSMB > semicon-smd-ipc : SMB](#fzesemiconsmipcsmb--semicon-smd-ipc--smb)
	* [Tags](#tags)
  
NO IMAGE  
# FZESEMICONSMIPCSMB > semicon-smd-ipc : SMB
...
|Full OOMP ID|oompID|FOOTPRINT-eagle-eagle-default-semicon-smd-ipc-SMB|
|Hex ID (short code)|hexID|FZESEMICONSMIPCSMB|
|name|name|semicon-smd-ipc : SMB|
||||

...
* [FZEOPTOCOUPLERSFH > optocoupler : SFH](#fzeoptocouplersfh--optocoupler--sfh)
	* [Tags](#tags)
  
NO IMAGE  
# FZEOPTOCOUPLERSFH > optocoupler : SFH
...
|OOMP Index|oompIndex|SFH|
|Full OOMP ID|oompID|FOOTPRINT-eagle-eagle-default-optocoupler-SFH|
|Hex ID (short code)|hexID|FZEOPTOCOUPLERSFH|
|name|name|optocoupler : SFH|
||||

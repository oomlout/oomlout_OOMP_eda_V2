...
* [FZEOPTOCOUPLERSM4 > optocoupler : SMD4](#fzeoptocouplersm4--optocoupler--smd4)
	* [Tags](#tags)
  
NO IMAGE  
# FZEOPTOCOUPLERSM4 > optocoupler : SMD4
...
|OOMP Index|oompIndex|SMD4|
|Full OOMP ID|oompID|FOOTPRINT-eagle-eagle-default-optocoupler-SMD4|
|Hex ID (short code)|hexID|FZEOPTOCOUPLERSM4|
|name|name|optocoupler : SMD4|
||||

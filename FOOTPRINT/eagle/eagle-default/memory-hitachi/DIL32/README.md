...
* [FZEMEMORYHITACHIDIL32 > memory-hitachi : DIL32](#fzememoryhitachidil32--memory-hitachi--dil32)
	* [Tags](#tags)
  
NO IMAGE  
# FZEMEMORYHITACHIDIL32 > memory-hitachi : DIL32
...
|Full OOMP ID|oompID|FOOTPRINT-eagle-eagle-default-memory-hitachi-DIL32|
|Hex ID (short code)|hexID|FZEMEMORYHITACHIDIL32|
|name|name|memory-hitachi : DIL32|
||||

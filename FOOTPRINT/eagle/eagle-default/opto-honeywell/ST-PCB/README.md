...
* [FZEOPTOHONEYWELLSTPCB > opto-honeywell : ST-PCB](#fzeoptohoneywellstpcb--opto-honeywell--st-pcb)
	* [Tags](#tags)
  
NO IMAGE  
# FZEOPTOHONEYWELLSTPCB > opto-honeywell : ST-PCB
...
|OOMP Index|oompIndex|ST-PCB|
|Full OOMP ID|oompID|FOOTPRINT-eagle-eagle-default-opto-honeywell-ST-PCB|
|Hex ID (short code)|hexID|FZEOPTOHONEYWELLSTPCB|
|name|name|opto-honeywell : ST-PCB|
||||

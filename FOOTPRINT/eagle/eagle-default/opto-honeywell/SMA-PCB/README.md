...
* [FZEOPTOHONEYWELLSPCB > opto-honeywell : SMA-PCB](#fzeoptohoneywellspcb--opto-honeywell--sma-pcb)
	* [Tags](#tags)
  
NO IMAGE  
# FZEOPTOHONEYWELLSPCB > opto-honeywell : SMA-PCB
...
|OOMP Index|oompIndex|SMA-PCB|
|Full OOMP ID|oompID|FOOTPRINT-eagle-eagle-default-opto-honeywell-SMA-PCB|
|Hex ID (short code)|hexID|FZEOPTOHONEYWELLSPCB|
|name|name|opto-honeywell : SMA-PCB|
||||

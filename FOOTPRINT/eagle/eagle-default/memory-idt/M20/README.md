...
* [FZEMEMORYIDTM2 > memory-idt : M20](#fzememoryidtm2--memory-idt--m20)
	* [Tags](#tags)
  
NO IMAGE  
# FZEMEMORYIDTM2 > memory-idt : M20
...
|OOMP Index|oompIndex|M20|
|Full OOMP ID|oompID|FOOTPRINT-eagle-eagle-default-memory-idt-M20|
|Hex ID (short code)|hexID|FZEMEMORYIDTM2|
|name|name|memory-idt : M20|
||||

...
* [FZSRTXPORT > SparkFun-Retired : XPORT](#fzsrtxport--sparkfun-retired--xport)
	* [Tags](#tags)
  
NO IMAGE  
# FZSRTXPORT > SparkFun-Retired : XPORT
...
|OOMP Index|oompIndex|XPORT|
|Full OOMP ID|oompID|FOOTPRINT-eagle-SparkFun-Eagle-Libraries-SparkFun-Retired-XPORT|
|Hex ID (short code)|hexID|FZSRTXPORT|
|name|name|SparkFun-Retired : XPORT|
||||

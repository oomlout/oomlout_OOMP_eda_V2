...
* [FZSRTUMBH > SparkFun-Retired : USB-MB-H](#fzsrtumbh--sparkfun-retired--usb-mb-h)
	* [Tags](#tags)
  
NO IMAGE  
# FZSRTUMBH > SparkFun-Retired : USB-MB-H
...
|OOMP Index|oompIndex|USB-MB-H|
|Full OOMP ID|oompID|FOOTPRINT-eagle-SparkFun-Eagle-Libraries-SparkFun-Retired-USB-MB-H|
|Hex ID (short code)|hexID|FZSRTUMBH|
|name|name|SparkFun-Retired : USB-MB-H|
||||

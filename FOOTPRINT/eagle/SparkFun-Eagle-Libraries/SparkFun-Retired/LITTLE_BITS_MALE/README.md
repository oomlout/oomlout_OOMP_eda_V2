...
* [FZSRTLITTLEBITSMALE > SparkFun-Retired : LITTLE_BITS_MALE](#fzsrtlittlebitsmale--sparkfun-retired--little_bits_male)
	* [Tags](#tags)
  
NO IMAGE  
# FZSRTLITTLEBITSMALE > SparkFun-Retired : LITTLE_BITS_MALE
...
|OOMP Index|oompIndex|LITTLE_BITS_MALE|
|Full OOMP ID|oompID|FOOTPRINT-eagle-SparkFun-Eagle-Libraries-SparkFun-Retired-LITTLE_BITS_MALE|
|Hex ID (short code)|hexID|FZSRTLITTLEBITSMALE|
|name|name|SparkFun-Retired : LITTLE_BITS_MALE|
||||

...
* [FZSRTMSDSOSDIO > SparkFun-Retired : MICRO-SD-SOCKET-SDIO](#fzsrtmsdsosdio--sparkfun-retired--micro-sd-socket-sdio)
	* [Tags](#tags)
  
NO IMAGE  
# FZSRTMSDSOSDIO > SparkFun-Retired : MICRO-SD-SOCKET-SDIO
...
|Full OOMP ID|oompID|FOOTPRINT-eagle-SparkFun-Eagle-Libraries-SparkFun-Retired-MICRO-SD-SOCKET-SDIO|
|Hex ID (short code)|hexID|FZSRTMSDSOSDIO|
|name|name|SparkFun-Retired : MICRO-SD-SOCKET-SDIO|
||||

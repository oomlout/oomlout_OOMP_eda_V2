...
* [FZSSPARKFUNSENSBARCODEREADERMO > SparkFun-Sensors : BARCODE_READER_MODULE](#fzssparkfunsensbarcodereadermo--sparkfun-sensors--barcode_reader_module)
	* [Tags](#tags)
  
NO IMAGE  
# FZSSPARKFUNSENSBARCODEREADERMO > SparkFun-Sensors : BARCODE_READER_MODULE
...
|OOMP Index|oompIndex|BARCODE_READER_MODULE|
|Full OOMP ID|oompID|FOOTPRINT-eagle-SparkFun-Eagle-Libraries-SparkFun-Sensors-BARCODE_READER_MODULE|
|Hex ID (short code)|hexID|FZSSPARKFUNSENSBARCODEREADERMO|
|name|name|SparkFun-Sensors : BARCODE_READER_MODULE|
||||

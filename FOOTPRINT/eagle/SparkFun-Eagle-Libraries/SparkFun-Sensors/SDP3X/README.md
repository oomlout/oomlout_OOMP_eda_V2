...
* [FZSSPARKFUNSENSSDP3X > SparkFun-Sensors : SDP3X](#fzssparkfunsenssdp3x--sparkfun-sensors--sdp3x)
	* [Tags](#tags)
  
NO IMAGE  
# FZSSPARKFUNSENSSDP3X > SparkFun-Sensors : SDP3X
...
|OOMP Index|oompIndex|SDP3X|
|Full OOMP ID|oompID|FOOTPRINT-eagle-SparkFun-Eagle-Libraries-SparkFun-Sensors-SDP3X|
|Hex ID (short code)|hexID|FZSSPARKFUNSENSSDP3X|
|name|name|SparkFun-Sensors : SDP3X|
||||

...
* [FZSUMICSXXXX > User-Submitted : MICS-XXXX](#fzsumicsxxxx--user-submitted--mics-xxxx)
	* [Tags](#tags)
  
NO IMAGE  
# FZSUMICSXXXX > User-Submitted : MICS-XXXX
...
|OOMP Index|oompIndex|MICS-XXXX|
|Full OOMP ID|oompID|FOOTPRINT-eagle-SparkFun-Eagle-Libraries-User-Submitted-MICS-XXXX|
|Hex ID (short code)|hexID|FZSUMICSXXXX|
|name|name|User-Submitted : MICS-XXXX|
||||

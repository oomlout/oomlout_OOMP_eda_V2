...
NO IMAGE  
# FZSU16LPCC > User-Submitted : 16LPCC
...
|OOMP Index|oompIndex|16LPCC|
|Full OOMP ID|oompID|FOOTPRINT-eagle-SparkFun-Eagle-Libraries-User-Submitted-16LPCC|
|Hex ID (short code)|hexID|FZSU16LPCC|
|name|name|User-Submitted : 16LPCC|
||||

...
* [FZSUMS8 > User-Submitted : MSOP8](#fzsums8--user-submitted--msop8)
	* [Tags](#tags)
  
NO IMAGE  
# FZSUMS8 > User-Submitted : MSOP8
...
|Full OOMP ID|oompID|FOOTPRINT-eagle-SparkFun-Eagle-Libraries-User-Submitted-MSOP8|
|Hex ID (short code)|hexID|FZSUMS8|
|name|name|User-Submitted : MSOP8|
||||

...
* [FZSULDUALCOLOR3 > User-Submitted : LED-DUALCOLOR-3MM](#fzsuldualcolor3--user-submitted--led-dualcolor-3mm)
	* [Tags](#tags)
  
NO IMAGE  
# FZSULDUALCOLOR3 > User-Submitted : LED-DUALCOLOR-3MM
...
|OOMP Index|oompIndex|LED-DUALCOLOR-3MM|
|Full OOMP ID|oompID|FOOTPRINT-eagle-SparkFun-Eagle-Libraries-User-Submitted-LED-DUALCOLOR-3MM|
|Hex ID (short code)|hexID|FZSULDUALCOLOR3|
|name|name|User-Submitted : LED-DUALCOLOR-3MM|
||||

...
* [FZSLLBARSM > SparkFun-LED : LED_BAR_SMD](#fzsllbarsm--sparkfun-led--led_bar_smd)
	* [Tags](#tags)
  
NO IMAGE  
# FZSLLBARSM > SparkFun-LED : LED_BAR_SMD
...
|OOMP Index|oompIndex|LED_BAR_SMD|
|Full OOMP ID|oompID|FOOTPRINT-eagle-SparkFun-Eagle-Libraries-SparkFun-LED-LED_BAR_SMD|
|Hex ID (short code)|hexID|FZSLLBARSM|
|name|name|SparkFun-LED : LED_BAR_SMD|
||||

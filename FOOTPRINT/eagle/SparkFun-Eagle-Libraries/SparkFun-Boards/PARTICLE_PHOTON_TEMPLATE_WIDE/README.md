...
NO IMAGE  
# FZSBOPARTICLEPHOTONTEMPLATEWIDE > SparkFun-Boards : PARTICLE_PHOTON_TEMPLATE_WIDE

- ID: FOOTPRINT-eagle-SparkFun-Eagle-Libraries-SparkFun-Boards-PARTICLE_PHOTON_TEMPLATE_WIDE
- Hex ID: FZSBOPARTICLEPHOTONTEMPLATEWIDE
- Name: SparkFun-Boards : PARTICLE_PHOTON_TEMPLATE_WIDE
- Path: oomlout_OOMP_eda_V2/FOOTPRINT/eagle/SparkFun-Eagle-Libraries/SparkFun-Boards/PARTICLE_PHOTON_TEMPLATE_WIDE/
...
|OOMP Index|oompIndex|PARTICLE_PHOTON_TEMPLATE_WIDE|
|Full OOMP ID|oompID|FOOTPRINT-eagle-SparkFun-Eagle-Libraries-SparkFun-Boards-PARTICLE_PHOTON_TEMPLATE_WIDE|
|Hex ID (short code)|hexID|FZSBOPARTICLEPHOTONTEMPLATEWIDE|
|name|name|SparkFun-Boards : PARTICLE_PHOTON_TEMPLATE_WIDE|
||||

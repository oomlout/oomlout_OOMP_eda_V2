...
* [FZSRPOTDUALPPVERTK > SparkFun-Resistors : POT-DUAL-PTH-PANASONIC-VERT-KIT](#fzsrpotdualppvertk--sparkfun-resistors--pot-dual-pth-panasonic-vert-kit)
	* [Tags](#tags)
  
NO IMAGE  
# FZSRPOTDUALPPVERTK > SparkFun-Resistors : POT-DUAL-PTH-PANASONIC-VERT-KIT
...
|OOMP Index|oompIndex|POT-DUAL-PTH-PANASONIC-VERT-KIT|
|Full OOMP ID|oompID|FOOTPRINT-eagle-SparkFun-Eagle-Libraries-SparkFun-Resistors-POT-DUAL-PTH-PANASONIC-VERT-KIT|
|Hex ID (short code)|hexID|FZSRPOTDUALPPVERTK|
|name|name|SparkFun-Resistors : POT-DUAL-PTH-PANASONIC-VERT-KIT|
||||

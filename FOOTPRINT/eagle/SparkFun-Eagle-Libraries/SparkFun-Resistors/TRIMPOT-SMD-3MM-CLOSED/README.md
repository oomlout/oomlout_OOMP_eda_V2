...
NO IMAGE  
# FZSRTRIMPOTSM3CLOSED > SparkFun-Resistors : TRIMPOT-SMD-3MM-CLOSED
...
|OOMP Index|oompIndex|TRIMPOT-SMD-3MM-CLOSED|
|Full OOMP ID|oompID|FOOTPRINT-eagle-SparkFun-Eagle-Libraries-SparkFun-Resistors-TRIMPOT-SMD-3MM-CLOSED|
|Hex ID (short code)|hexID|FZSRTRIMPOTSM3CLOSED|
|name|name|SparkFun-Resistors : TRIMPOT-SMD-3MM-CLOSED|
||||

...
* [FZSRFLEXSEN > SparkFun-Resistors : FLEX_SENSOR](#fzsrflexsen--sparkfun-resistors--flex_sensor)
	* [Tags](#tags)
  
NO IMAGE  
# FZSRFLEXSEN > SparkFun-Resistors : FLEX_SENSOR
...
|OOMP Index|oompIndex|FLEX_SENSOR|
|Full OOMP ID|oompID|FOOTPRINT-eagle-SparkFun-Eagle-Libraries-SparkFun-Resistors-FLEX_SENSOR|
|Hex ID (short code)|hexID|FZSRFLEXSEN|
|name|name|SparkFun-Resistors : FLEX_SENSOR|
||||

...
def load(newPart,it):
    ...
    oIndex = "HEAD-JSTSH-X-PI19-SM-HSH19"
    hexID = "SZKICADOOMLOUTOOMPKICADOOMLOUTOOMPPARTSHEADJSTSHXPI19SMHSH19"
    ...
    newPart['name'].append('oomlout_OOMP_parts : HEAD-JSTSH-X-PI19-SM-HSH19')

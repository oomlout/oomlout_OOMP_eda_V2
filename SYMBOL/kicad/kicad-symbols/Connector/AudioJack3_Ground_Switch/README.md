...
* [SZKCNAUDIOJ3GROUNDSW > Connector : AudioJack3_Ground_Switch](#szkcnaudioj3groundsw--connector--audiojack3_ground_switch)
	* [Images](#images)
	* [Tags](#tags)
  
![][im]
# SZKCNAUDIOJ3GROUNDSW > Connector : AudioJack3_Ground_Switch

- ID: SYMBOL-kicad-kicad-symbols-Connector-AudioJack3_Ground_Switch
- Hex ID: SZKCNAUDIOJ3GROUNDSW
- Name: Connector : AudioJack3_Ground_Switch
- Path: oomlout_OOMP_eda_V2/SYMBOL/kicad/kicad-symbols/Connector/AudioJack3_Ground_Switch/
...
- Short Link: [http://oom.lt/SZKCNAUDIOJ3GROUNDSW](http://oom.lt/SZKCNAUDIOJ3GROUNDSW)
...
|Hex ID (short code)|hexID|SZKCNAUDIOJ3GROUNDSW|

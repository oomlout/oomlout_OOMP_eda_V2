...
* [SZKCNCPICICSPICD > Connector : Conn_PIC_ICSP_ICD](#szkcncpicicspicd--connector--conn_pic_icsp_icd)
	* [Images](#images)
	* [Tags](#tags)
  
![][im]
# SZKCNCPICICSPICD > Connector : Conn_PIC_ICSP_ICD

- ID: SYMBOL-kicad-kicad-symbols-Connector-Conn_PIC_ICSP_ICD
- Hex ID: SZKCNCPICICSPICD
- Name: Connector : Conn_PIC_ICSP_ICD
- Path: oomlout_OOMP_eda_V2/SYMBOL/kicad/kicad-symbols/Connector/Conn_PIC_ICSP_ICD/
...
- Short Link: [http://oom.lt/SZKCNCPICICSPICD](http://oom.lt/SZKCNCPICICSPICD)
...
|Hex ID (short code)|hexID|SZKCNCPICICSPICD|

...
* [SZKDEVICETHERMISTORNTC3W > Device : Thermistor_NTC_3Wire](#szkdevicethermistorntc3w--device--thermistor_ntc_3wire)
	* [Images](#images)
	* [Tags](#tags)
  
![][im]
# SZKDEVICETHERMISTORNTC3W > Device : Thermistor_NTC_3Wire

- ID: SYMBOL-kicad-kicad-symbols-Device-Thermistor_NTC_3Wire
- Hex ID: SZKDEVICETHERMISTORNTC3W
- Name: Device : Thermistor_NTC_3Wire
- Path: oomlout_OOMP_eda_V2/SYMBOL/kicad/kicad-symbols/Device/Thermistor_NTC_3Wire/
...
- Short Link: [http://oom.lt/SZKDEVICETHERMISTORNTC3W](http://oom.lt/SZKDEVICETHERMISTORNTC3W)
...
|Hex ID (short code)|hexID|SZKDEVICETHERMISTORNTC3W|

...
- Hex ID: SZKDEVICEQPNPDARLINGTONCEB
- Name: Device : Q_PNP_Darlington_CEB
- Description: Device : Q_PNP_Darlington_CEB
- Long Link: [http://oom.lt/SYMBOL-kicad-kicad-symbols-Device-Q_PNP_Darlington_CEB](http://oom.lt/SYMBOL-kicad-kicad-symbols-Device-Q_PNP_Darlington_CEB)
- Short Link: [http://oom.lt/SZKDEVICEQPNPDARLINGTONCEB](http://oom.lt/SZKDEVICEQPNPDARLINGTONCEB)

## Distributor Searches
  
Links to search for this item (using OOMP name) at various distributors  
[(Aliexpress) ](https://www.aliexpress.com/wholesale?SearchText=1117Device+:+Q_PNP_Darlington_CEB)&nbsp;&nbsp;&nbsp;[(Avnet) ](https://www.avnet.com/shop/us/search/Device+:+Q_PNP_Darlington_CEB)&nbsp;&nbsp;&nbsp;[(Digikey) ](https://www.digikey.co.uk/en/products/result?s=Device+:+Q_PNP_Darlington_CEB)&nbsp;&nbsp;&nbsp;[(LCSC) ](https://www.lcsc.com/search?q=Device+:+Q_PNP_Darlington_CEB)&nbsp;&nbsp;&nbsp;[(Farnell) ](https://uk.farnell.com/search?st=Device+:+Q_PNP_Darlington_CEB)&nbsp;&nbsp;&nbsp;[(Mouser) ](https://www.mouser.com/c/?q=Device+:+Q_PNP_Darlington_CEB)&nbsp;&nbsp;&nbsp;
## MPNs
...
|OOMP Index|oompIndex|Q_PNP_Darlington_CEB|
|Full OOMP ID|oompID|SYMBOL-kicad-kicad-symbols-Device-Q_PNP_Darlington_CEB|
|Hex ID (short code)|hexID|SZKDEVICEQPNPDARLINGTONCEB|

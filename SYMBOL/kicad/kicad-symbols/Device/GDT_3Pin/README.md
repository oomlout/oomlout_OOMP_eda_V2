...
* [SZKDEVICEGDT3P > Device : GDT_3Pin](#szkdevicegdt3p--device--gdt_3pin)
	* [Images](#images)
	* [Tags](#tags)
  
![][im]
# SZKDEVICEGDT3P > Device : GDT_3Pin

- ID: SYMBOL-kicad-kicad-symbols-Device-GDT_3Pin
- Hex ID: SZKDEVICEGDT3P
- Name: Device : GDT_3Pin
- Path: oomlout_OOMP_eda_V2/SYMBOL/kicad/kicad-symbols/Device/GDT_3Pin/
...
- Short Link: [http://oom.lt/SZKDEVICEGDT3P](http://oom.lt/SZKDEVICEGDT3P)
...
|Hex ID (short code)|hexID|SZKDEVICEGDT3P|

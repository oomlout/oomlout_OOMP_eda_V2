...
- Hex ID: SZKDEVICEDZENERDUALCOONCATHODEKAA
- Name: Device : D_Zener_Dual_CommonCathode_KAA
- Description: Device : D_Zener_Dual_CommonCathode_KAA
- Long Link: [http://oom.lt/SYMBOL-kicad-kicad-symbols-Device-D_Zener_Dual_CommonCathode_KAA](http://oom.lt/SYMBOL-kicad-kicad-symbols-Device-D_Zener_Dual_CommonCathode_KAA)
- Short Link: [http://oom.lt/SZKDEVICEDZENERDUALCOONCATHODEKAA](http://oom.lt/SZKDEVICEDZENERDUALCOONCATHODEKAA)

## Distributor Searches
  
Links to search for this item (using OOMP name) at various distributors  
[(Aliexpress) ](https://www.aliexpress.com/wholesale?SearchText=1117Device+:+D_Zener_Dual_CommonCathode_KAA)&nbsp;&nbsp;&nbsp;[(Avnet) ](https://www.avnet.com/shop/us/search/Device+:+D_Zener_Dual_CommonCathode_KAA)&nbsp;&nbsp;&nbsp;[(Digikey) ](https://www.digikey.co.uk/en/products/result?s=Device+:+D_Zener_Dual_CommonCathode_KAA)&nbsp;&nbsp;&nbsp;[(LCSC) ](https://www.lcsc.com/search?q=Device+:+D_Zener_Dual_CommonCathode_KAA)&nbsp;&nbsp;&nbsp;[(Farnell) ](https://uk.farnell.com/search?st=Device+:+D_Zener_Dual_CommonCathode_KAA)&nbsp;&nbsp;&nbsp;[(Mouser) ](https://www.mouser.com/c/?q=Device+:+D_Zener_Dual_CommonCathode_KAA)&nbsp;&nbsp;&nbsp;
## MPNs
...
|OOMP Index|oompIndex|D_Zener_Dual_CommonCathode_KAA|
|Full OOMP ID|oompID|SYMBOL-kicad-kicad-symbols-Device-D_Zener_Dual_CommonCathode_KAA|
|Hex ID (short code)|hexID|SZKDEVICEDZENERDUALCOONCATHODEKAA|

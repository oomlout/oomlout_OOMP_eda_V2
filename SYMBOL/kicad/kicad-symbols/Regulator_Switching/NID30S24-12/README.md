...
|oomlout_OOMP_eda_V2/SYMBOL/kicad/kicad-symbols/Regulator_Switching/NID30S24-12/image.png||||
| :---: | :---: | :---: | :---: |
...
|name|name|NID30S24-12|
|Symbol Kicad Details|symbolKicadDetails|[{'kicadSymbolExtends': 'NID30S24-05', 'kicadSymbolReference': 'U', 'kicadSymbolValue': 'NID30S24-12', 'kicadSymbolFootprint': 'Converter_DCDC:Converter_DCDC_MeanWell_NID30_THT', 'kicadSymbolDatasheet': 'http://www.meanwell.com/webapp/product/search.aspx?prod=nid30', 'kicadSymbolki_keywords': 'Step-Down Converter Module DC/DC', 'kicadSymbolki_description': '2.5A/30W Step Down Converter Module, fixed 12V Output Voltage, 250kHz, 20-53V Input Voltage', 'kicadSymbolki_fp_filters': 'Converter*DCDC*MeanWell*NID30*THT*'}]|
||||

...
|Name|name|MCP1804x-C002xDB|
|Symbol Kicad Details|symbolKicadDetails|[{'kicadSymbolExtends': 'MCP1804x-1802xDB', 'kicadSymbolReference': 'U', 'kicadSymbolValue': 'MCP1804x-C002xDB', 'kicadSymbolFootprint': 'Package_TO_SOT_SMD:SOT-223-3_TabPin2', 'kicadSymbolDatasheet': 'http://ww1.microchip.com/downloads/en/DeviceDoc/20002200D.pdf', 'kicadSymbolki_keywords': 'linear regulator ldo fixed positive', 'kicadSymbolki_description': '150mA, 28V LDO Regulator With Shutdown, 12.0V Fixed Output, SOT-223', 'kicadSymbolki_fp_filters': 'SOT?223*'}]|
||||
